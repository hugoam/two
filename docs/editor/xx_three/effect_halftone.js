...
function pass_halftone(gfx, render, halftone) {
    ...
    // @todo maybe type checking is a bit too much here (allow bool -> number and number -> bool)
    gfx.filter.uniform(pass, 'u_halftone_p2', new two.vec4(Number(halftone.disable), Number(halftone.grayscale), 0.0, 0.0));
