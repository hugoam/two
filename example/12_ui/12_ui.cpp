...
namespace game
{
	...
	struct GameStyles
	{
		...
		Style inventory_slot = { "InventorySlot", styles().item, { { { &Layout::m_size, vec2{ 40.f, 40.f } },{ &InkStyle::m_empty, false },{ &InkStyle::m_border_width, 1.f },{ &InkStyle::m_border_colour, Colour::AlphaGrey } } } };
	};
