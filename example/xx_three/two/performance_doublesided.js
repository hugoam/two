...
void xx_performance_doublesided(Shell app, Widget parent, Dockbar dockbar)
{
	...
	if(!once)
	{
		...
		scene.lights().add(Light(l0, LightType::Point, false, rgb(0x0011), 1.0, 5500.0));

		var l1 = scene.nodes().add(new two.Node3(new two.vec3(-4000.0, 0.0, 0.0)));
		scene.lights().add(Light(l1, LightType::Point, false, rgb(0xff1100), 1.0, 5500.0));

		var l2 = scene.nodes().add(new two.Node3(new two.vec3(0.0)));
		scene.lights().add(Light(l2, LightType::Point, false, rgb(0xffaa00), 2.0, 3000.0));
