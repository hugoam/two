...
--  mud_example("00_tutorial",          { mud.core },                                  {}, true)
    ...
    mud_example("05_character",         { mud.core, mud.gfx.pbr, mud.gfx.gltf, mud.gfx.gltf.refl }, { _G["03_materials"] })
    mud_example("06_particles",         { mud.core, mud.srlz, mud.gfx.refl },          {})
    mud_example("07_gltf",              { mud.core, mud.gfx.pbr, mud.gfx.gltf, mud.gfx.gltf.refl }, {})
