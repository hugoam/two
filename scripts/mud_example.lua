...
if not _OPTIONS["renderer-gl"] then
    ...
    mud_example("02_camera",            { "03_materials" })
    mud_example("04_lights",            { "01_shapes", "03_materials" })
    mud_example("04_sponza",            { "01_shapes", "03_materials" })
    --mud_example("05_character",       "03_materials")
    mud_example("06_particles",         {})
    mud_example("07_gltf",              {})
    mud_example("07_prefabs",           { "07_gltf" })
    mud_example("08_sky",               { "01_shapes", "03_materials" })
    mud_example("09_live_shader",       {})
    mud_example("10_post_process",      { "01_shapes", "03_materials" })
    mud_example("11_selection",         { "01_shapes", "03_materials" })
    mud_example("12_ui",                { "01_shapes", "03_materials" })
    mud_example("13_live_ui",           {})
    mud_example("14_live_gfx",          {})
    mud_example("14_live_gfx_visual",   {})
    mud_example("15_script",            { "01_shapes", "03_materials" }, true)
    mud_example("16_visual_script",     { "01_shapes", "03_materials" })
    mud_example("17_wfc",               {})
    --mud_example("18_pathfinding",     {})
    mud_example("19_multi_viewport",    {})
    mud_example("20_meta",              { "01_shapes", "03_materials" })
end
