...
void main()
{
	...
	gl_FragColor = blur_7(s_source_0, v_texcoord0.xy, u_blur_lod, u_kernel_0, u_kernel_1, u_kernel_2, u_kernel_3, u_kernel_4, u_kernel_5, u_kernel_6);
#endif

#ifdef GAUSSIAN_VERTICAL
	gl_FragColor = blur_5(s_source_0, v_texcoord0.xy, u_blur_lod, u_kernel_0, u_kernel_1, u_kernel_2, u_kernel_3, u_kernel_4);
#endif
}
