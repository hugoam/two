...
namespace mud
{
	...
	MUD_PROCGEN_GFX_EXPORT void paint_tiles(Gnode& parent, Ref object, WfcBlock& tileblock, const uvec3& focused = uvec3(UINT32_MAX), const uvec3* exclude = nullptr, bool draw_entropy = false);
	...
	MUD_PROCGEN_GFX_EXPORT void paint_tileblock(Gnode& parent, Ref object, WfcBlock& tileblock, const uvec3& focused = uvec3(UINT32_MAX), const uvec3* exclude = nullptr, bool draw_entropy = false);
