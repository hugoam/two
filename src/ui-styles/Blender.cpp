...
namespace mud
{
	...
	void style_blender_dark(UiWindow& ui_window)
	{
		...
		Colour active_blue_alpha = from_rgba(0x5680c2e6);
		Colour active_blue = from_rgba(0x5680c2ff);
		Colour grey_37 = from_rgba(0x373737ff);
		Colour grey_44 = from_rgba(0x444444ff);
		Colour grey_58 = from_rgba(0x585858ff);
		Colour grey_59 = from_rgba(0x595959ff);
		Colour white_d9 = from_rgba(0xd9d9d9ff);
		Colour white_e6 = from_rgba(0xe6e6e6ff);
		Colour white = from_rgba(0xffffffff);
		...
		{
			i.m_border_colour = grey_37;
			i.m_background_colour = from_rgba(0x313131ff);
			s.m_background_colour = active_blue;
		...
		auto wcol_text = [=](InkStyle& i, InkStyle& s)
		{
			...
			i.m_background_colour = from_rgba(0x1f1f1fff);
			s.m_background_colour = from_rgba(0xb3b3b333);
		...
		{
			i.m_border_colour = grey_37;
			i.m_background_colour = from_rgba(0x666666ff);
			s.m_background_colour = active_blue_alpha;
			//.item = RGBA(0xffffffff);
			i.m_text_colour = white_e6;
			s.m_text_colour = white;
		...
		{
			i.m_border_colour = from_rgba(0x202020ff);
			i.m_background_colour = from_rgba(0x2b2b2bff);
			s.m_background_colour = from_rgba(0x424242ff);
			//.item = RGBA(0x2d2d2dff);
			i.m_text_colour = from_rgba(0x989898ff);
			s.m_text_colour = white;
			//.roundness = 0.2f,
		};
		...
		{
			i.m_border_colour = grey_44;
			i.m_background_colour = from_rgba(0x2c2c2cff);
			s.m_background_colour = from_rgba(0x696e76ff);
		...
		{
			i.m_border_colour = from_rgba(0x4d4d4dff);
			i.m_background_colour = from_rgba(0x2e2e2ecc);
			s.m_background_colour = active_blue_alpha;
		...
		{
			i.m_border_colour = from_rgba(0x19191aff);
			i.m_background_colour = from_rgba(0x1f1f1fef);
			s.m_background_colour = from_rgba(0x585858ff);
			//.item = RGBA(0x727272ff);
			i.m_text_colour = from_rgba(0xa5a5a5ff);
			s.m_text_colour = white;
			//.shadetop = 25,
			//.shadedown = -20,
			//.roundness = 0.2f,
		...
		{
			i.m_border_colour = from_rgba(0x19191aff);
			i.m_background_colour = from_rgba(0x19191aef);
			s.m_background_colour = from_rgba(0x19191aef);
		...
		{
			i.m_border_colour = grey_44;
			i.m_background_colour = from_rgba(0x00000033);
			s.m_background_colour = from_rgba(0x696e76ff);
			//.item = RGBA(0x191919ff);
			i.m_text_colour = white_e6;
			s.m_text_colour = white;
		...
		{
			i.m_border_colour = from_rgba(0x424242ff);
			i.m_background_colour = from_rgba(0x67676700);
			s.m_background_colour = from_rgba(0xb3b3b3ff);
		...
		{
			i.m_border_colour = from_rgba(0x585858ff);
			i.m_background_colour = from_rgba(0x2c2c2cff);
			s.m_background_colour = active_blue;
		...
		{
			i.m_border_colour = from_rgba(0x2d2d2dff);
			i.m_background_colour = from_rgba(0x2d2d2d00);
			s.m_background_colour = from_rgba(0x696e76ff);
		...
		{
			i.m_border_colour = from_rgba(0x333333ff);
			i.m_background_colour = from_rgba(0x212121ef);
			s.m_background_colour = active_blue_alpha;
