...
namespace mud
{
    template <> MUD_PROCGEN_EXPORT Type& type<mud::Noise::CellularDistanceFunction>();
    template <> MUD_PROCGEN_EXPORT Type& type<mud::Noise::CellularReturnType>();
    template <> MUD_PROCGEN_EXPORT Type& type<mud::Noise::FractalType>();
    template <> MUD_PROCGEN_EXPORT Type& type<mud::Noise::Interp>();
    template <> MUD_PROCGEN_EXPORT Type& type<mud::Noise::NoiseType>();
    
#ifdef MUD_PROCGEN_REFLECTION_IMPL
    void mudprocgen_meta(Module& m)
    {   
    // Base Types
