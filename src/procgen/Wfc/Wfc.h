...
#define MUD_WFC_PROPAGATION_VEC
	...
	export_ struct refl_ MUD_PROCGEN_EXPORT Tileset
	{
		attr_ string m_name;
	...
	export_ struct refl_ MUD_PROCGEN_EXPORT Wave
	{
		Wave();
	...
	export_ struct refl_ MUD_PROCGEN_EXPORT WaveTileset : public Tileset
	{
	...
	export_ struct refl_ MUD_PROCGEN_EXPORT TileWave : public Wave
	{
		TileWave();
