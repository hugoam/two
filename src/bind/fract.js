...
function Circlifier(a0) {
    ...
    this.__ptr = _two_Circlifier__construct_1(/*image*/a0.__ptr); getCache(Circlifier)[this.__ptr] = this;
};
...
Circlifier.prototype["__destroy"] = Circlifier.prototype.__destroy = function() {
    _two_Circlifier__destroy(this.__ptr);
};
// Pattern
function Pattern(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Pattern__construct_0(); getCache(Pattern)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Pattern__construct_2(/*palette*/a0.__ptr, /*sampling*/a1); getCache(Pattern)[this.__ptr] = this; }
    else if (a3 === undefined) { this.__ptr = _two_Pattern__construct_3(/*palette*/a0.__ptr, /*sampling*/a1, /*precision*/a2); getCache(Pattern)[this.__ptr] = this; }
    else { this.__ptr = _two_Pattern__construct_4(/*palette*/a0.__ptr, /*sampling*/a1, /*precision*/a2, /*step*/a3); getCache(Pattern)[this.__ptr] = this; }
};
...
Pattern.prototype["__destroy"] = Pattern.prototype.__destroy = function() {
    _two_Pattern__destroy(this.__ptr);
};
// FractTab
function FractTab() {
...
FractTab.prototype["__destroy"] = FractTab.prototype.__destroy = function() {
    _two_FractTab__destroy(this.__ptr);
};
// Fract
function Fract(a0) {
    if (a0 === undefined) {  }
    else { if (typeof a0 !== 'number') throw Error('Fract(0:num_tabs): expected integer'); }
    if (a0 === undefined) { this.__ptr = _two_Fract__construct_0(); getCache(Fract)[this.__ptr] = this; }
    else { this.__ptr = _two_Fract__construct_1(/*num_tabs*/a0); getCache(Fract)[this.__ptr] = this; }
};
...
Fract.prototype["generate"] = Fract.prototype.generate = function(a0) {
    ...
    if (a0 === undefined) { _two_Fract_generate_0(this.__ptr); }
...
Fract.prototype["render"] = Fract.prototype.render = function(a0, a1, a2, a3) {
    ...
    _two_Fract_render_4(this.__ptr, /*rect*/a0.__ptr, /*pattern*/a1.__ptr, /*resolution*/a2.__ptr, /*output_image*/a3.__ptr);
};
Fract.prototype["render_whole"] = Fract.prototype.render_whole = function(a0, a1, a2) {
    ...
    _two_Fract_render_whole_3(this.__ptr, /*pattern*/a0.__ptr, /*resolution*/a1.__ptr, /*output_image*/a2.__ptr);
};
Object.defineProperty(Fract.prototype, "nutabs", {
    get: function() {
        return _two_Fract__get_nutabs(this.__ptr);
    },
    set: function(value) {
        if (typeof value !== 'number') throw Error('Fract.nutabs: expected integer');
        _two_Fract__set_nutabs(this.__ptr, value);
    }
});
Fract.prototype["__destroy"] = Fract.prototype.__destroy = function() {
    _two_Fract__destroy(this.__ptr);
};
// FractSample
function FractSample(a0, a1, a2) {
    ...
    this.__ptr = _two_FractSample__construct_3(/*fract*/a0.__ptr, /*rect*/a1.__ptr, /*resolution*/a2.__ptr); getCache(FractSample)[this.__ptr] = this;
};
...
FractSample.prototype["render"] = FractSample.prototype.render = function(a0, a1) {
    ...
    _two_FractSample_render_2(this.__ptr, /*pattern*/a0.__ptr, /*outputImage*/a1.__ptr);
};
Object.defineProperty(FractSample.prototype, "fract", {
    get: function() {
        return wrapPointer(_two_FractSample__get_fract(this.__ptr), Fract);
    }});
Object.defineProperty(FractSample.prototype, "rect", {
    get: function() {
        return wrapPointer(_two_FractSample__get_rect(this.__ptr), Rect);
    },
    set: function(value) {
        if (!checkClass(value, Rect)) throw Error('FractSample.rect: expected Rect');
        _two_FractSample__set_rect(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(FractSample.prototype, "resolution", {
    get: function() {
        return wrapPointer(_two_FractSample__get_resolution(this.__ptr), v2_uint);
    },
    set: function(value) {
        if (!checkClass(value, v2_uint)) throw Error('FractSample.resolution: expected v2<uint>');
        _two_FractSample__set_resolution(this.__ptr, value.__ptr);
    }
});
FractSample.prototype["__destroy"] = FractSample.prototype.__destroy = function() {
    _two_FractSample__destroy(this.__ptr);
};
Module['generate_fract'] = function(a0, a1, a2) {
    ...
    _two_generate_fract_3(/*resolution*/a0.__ptr, /*pattern*/a1.__ptr, /*output_image*/a2.__ptr);
};

(function() {
    function setup() {
        Circlifier.prototype.__type = _two_Circlifier__type();
        Pattern.prototype.__type = _two_Pattern__type();
        FractTab.prototype.__type = _two_FractTab__type();
        Fract.prototype.__type = _two_Fract__type();
        FractSample.prototype.__type = _two_FractSample__type();
        // PatternSampling
        Module['PatternSampling'] = Module['PatternSampling'] || {};
        Module['PatternSampling']['X'] = _two_PatternSampling_X();
        Module['PatternSampling']['XY'] = _two_PatternSampling_XY();
        Module['PatternSampling']['Depth'] = _two_PatternSampling_Depth();
    }
