...
function Circlifier(image) {
    /* image <mud::Image256> [] */
    image = image.ptr;
    this.ptr = _mud_Circlifier__construct_1(image); getCache(Circlifier)[this.ptr] = this;
...
function Fract(num_tabs) {
    /* num_tabs <size_t> [] */
    if (num_tabs === undefined) { this.ptr = _mud_Fract__construct_0(); getCache(Fract)[this.ptr] = this; return; }
    this.ptr = _mud_Fract__construct_1(num_tabs); getCache(Fract)[this.ptr] = this;
    this.type = Fract;
};
...
Fract.prototype["render"] = Fract.prototype.render = function(self, rect, pattern, resolution, output_image) {
    ...
    /* pattern <mud::Pattern> [] */
    pattern = pattern.ptr;
    /* resolution <mud::uvec2> [] */
    resolution = resolution.ptr;
    /* output_image <mud::Image256> [] */
...
function FractSample(fract, rect, resolution) {
    ...
    /* resolution <mud::uvec2> [] */
    resolution = resolution.ptr;
    this.ptr = _mud_FractSample__construct_3(fract, rect, resolution); getCache(FractSample)[this.ptr] = this;
...
// FractTab
function FractTab() {
    this.ptr = _mud_FractTab__construct_0(); getCache(FractTab)[this.ptr] = this;
    this.type = FractTab;
};
...
function Pattern(palette, sampling, precision, step) {
    /* palette <mud::Palette> [] */
    palette = palette.ptr;
    /* sampling <mud::PatternSampling> [] */
    if (sampling && typeof sampling === "object") sampling = sampling.ptr;
    /* precision <float> [] */
    /* step <size_t> [] */
    if (precision === undefined) { this.ptr = _mud_Pattern__construct_2(palette, sampling); getCache(Pattern)[this.ptr] = this; return; }
    if (step === undefined) { this.ptr = _mud_Pattern__construct_3(palette, sampling, precision); getCache(Pattern)[this.ptr] = this; return; }
    this.ptr = _mud_Pattern__construct_4(palette, sampling, precision, step); getCache(Pattern)[this.ptr] = this;
    this.type = Pattern;
};
