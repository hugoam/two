...
EMSCRIPTEN_BINDINGS(mud_ui)
{
    ...
    value_object<mud::Clipboard>("Clipboard")
        .field("text", &mud::Clipboard::text)
        .field("line_mode", &mud::Clipboard::line_mode)
        .field("pasted", &mud::Clipboard::pasted)
        ;
    value_object<mud::Dock>("Dock")
        ;
    value_object<mud::Gradient>("Gradient")
        .field("start", &mud::Gradient::start)
        .field("end", &mud::Gradient::end)
        ;
    value_object<mud::ImageSkin>("ImageSkin")
        ...
        .field("margin", &mud::ImageSkin::margin)
        .field("d_stretch", &mud::ImageSkin::d_stretch)
        ;
    value_object<mud::InkStyle>("InkStyle")
        .field("name", &mud::InkStyle::name)
        .field("empty", &mud::InkStyle::empty)
        .field("background_colour", &mud::InkStyle::background_colour)
        .field("border_colour", &mud::InkStyle::border_colour)
        .field("image_colour", &mud::InkStyle::image_colour)
        .field("text_colour", &mud::InkStyle::text_colour)
        .field("text_font", &mud::InkStyle::text_font)
        .field("text_size", &mud::InkStyle::text_size)
        .field("text_break", &mud::InkStyle::text_break)
        .field("text_wrap", &mud::InkStyle::text_wrap)
        .field("border_width", &mud::InkStyle::border_width)
        .field("corner_radius", &mud::InkStyle::corner_radius)
        .field("weak_corners", &mud::InkStyle::weak_corners)
        .field("padding", &mud::InkStyle::padding)
        .field("margin", &mud::InkStyle::margin)
        .field("align", &mud::InkStyle::align)
        .field("linear_gradient", &mud::InkStyle::linear_gradient)
        .field("linear_gradient_dim", &mud::InkStyle::linear_gradient_dim)
        .field("stretch", &mud::InkStyle::stretch)
        .field("image", &mud::InkStyle::image)
        .field("overlay", &mud::InkStyle::overlay)
        .field("tile", &mud::InkStyle::tile)
        .field("image_skin", &mud::InkStyle::image_skin)
        .field("shadow", &mud::InkStyle::shadow)
        .field("shadow_colour", &mud::InkStyle::shadow_colour)
        .field("hover_cursor", &mud::InkStyle::hover_cursor)
        ;
    value_object<mud::Layout>("Layout")
        .field("name", &mud::Layout::name)
        .field("solver", &mud::Layout::solver)
        .field("layout", &mud::Layout::layout)
        .field("flow", &mud::Layout::flow)
        .field("space", &mud::Layout::space)
        .field("clipping", &mud::Layout::clipping)
        .field("opacity", &mud::Layout::opacity)
        .field("align", &mud::Layout::align)
        .field("span", &mud::Layout::span)
        .field("size", &mud::Layout::size)
        .field("padding", &mud::Layout::padding)
        .field("margin", &mud::Layout::margin)
        .field("spacing", &mud::Layout::spacing)
        .field("pivot", &mud::Layout::pivot)
        .field("zorder", &mud::Layout::zorder)
        .field("no_grid", &mud::Layout::no_grid)
        .field("grid_division", &mud::Layout::grid_division)
        .field("table_division", &mud::Layout::table_division)
        .field("updated", &mud::Layout::updated)
        ;
    value_object<mud::NodeConnection>("NodeConnection")
        ;
    value_object<mud::Paint>("Paint")
        .field("fill_colour", &mud::Paint::fill_colour)
        .field("stroke_colour", &mud::Paint::stroke_colour)
        .field("stroke_width", &mud::Paint::stroke_width)
        ;
    ...
    value_object<mud::TextPaint>("TextPaint")
        .field("font", &mud::TextPaint::font)
        .field("colour", &mud::TextPaint::colour)
        .field("size", &mud::TextPaint::size)
        .field("align", &mud::TextPaint::align)
        .field("text_break", &mud::TextPaint::text_break)
        .field("text_wrap", &mud::TextPaint::text_wrap)
        ;
    value_object<mud::TextSelection>("TextSelection")
        ;
    value_object<mud::UiRect>("UiRect")
        .field("position", &mud::UiRect::position)
        .field("size", &mud::UiRect::size)
        .field("content", &mud::UiRect::content)
        .field("span", &mud::UiRect::span)
        .field("scale", &mud::UiRect::scale)
        ;
    ...
    class_<mud::Widget>("Widget")
        .property("frame", &mud::Widget::frame)
        .property("state", &mud::Widget::state)
        .property("switch", &mud::Widget::switch)
        .property("index", &mud::Widget::index)
        .property("open", &mud::Widget::open)
        .property("body", &mud::Widget::body)
