...
TileModel.prototype["__destroy"] = TileModel.prototype.__destroy = function() {
    _two_TileModel__destroy(this.__ptr);
};
// WfcBlock
function WfcBlock(a0, a1, a2, a3, a4) {
    ...
    if (a0 === undefined) { this.__ptr = _two_WfcBlock__construct_0(); getCache(WfcBlock)[this.__ptr] = this; }
    else if (a4 === undefined) { this.__ptr = _two_WfcBlock__construct_4(/*position*/a0.__ptr, /*size*/a1.__ptr, /*scale*/a2.__ptr, /*tileset*/a3.__ptr); getCache(WfcBlock)[this.__ptr] = this; }
    else { this.__ptr = _two_WfcBlock__construct_5(/*position*/a0.__ptr, /*size*/a1.__ptr, /*scale*/a2.__ptr, /*tileset*/a3.__ptr, /*auto_solve*/a4); getCache(WfcBlock)[this.__ptr] = this; }
};
...
WfcBlock.prototype["solve"] = WfcBlock.prototype.solve = function(a0) {
    ...
    if (a0 === undefined) { _two_WfcBlock_solve_0(this.__ptr); }
    else { _two_WfcBlock_solve_1(this.__ptr, /*limit*/a0); }
};
WfcBlock.prototype["update"] = WfcBlock.prototype.update = function(a0) {
    ...
    _two_WfcBlock_update_1(this.__ptr, /*wave*/a0.__ptr);
};
Object.defineProperty(WfcBlock.prototype, "position", {
    get: function() {
        return wrapPointer(_two_WfcBlock__get_position(this.__ptr), v3_float);
    },
    set: function(value) {
        if (!checkClass(value, v3_float)) throw Error('WfcBlock.position: expected v3<float>');
        _two_WfcBlock__set_position(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(WfcBlock.prototype, "size", {
    get: function() {
        return wrapPointer(_two_WfcBlock__get_size(this.__ptr), v3_uint);
    },
    set: function(value) {
        if (!checkClass(value, v3_uint)) throw Error('WfcBlock.size: expected v3<uint>');
        _two_WfcBlock__set_size(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(WfcBlock.prototype, "scale", {
    get: function() {
        return wrapPointer(_two_WfcBlock__get_scale(this.__ptr), v3_float);
    },
    set: function(value) {
        if (!checkClass(value, v3_float)) throw Error('WfcBlock.scale: expected v3<float>');
        _two_WfcBlock__set_scale(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(WfcBlock.prototype, "aabb", {
    get: function() {
        return wrapPointer(_two_WfcBlock__get_aabb(this.__ptr), Aabb);
    },
    set: function(value) {
        if (!checkClass(value, Aabb)) throw Error('WfcBlock.aabb: expected Aabb');
        _two_WfcBlock__set_aabb(this.__ptr, value.__ptr);
    }
});
WfcBlock.prototype["__destroy"] = WfcBlock.prototype.__destroy = function() {
    _two_WfcBlock__destroy(this.__ptr);
};

(function() {
    function setup() {
        TileModel.prototype.__type = _two_TileModel__type();
        WfcBlock.prototype.__type = _two_WfcBlock__type();
    }
