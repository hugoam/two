...
EMSCRIPTEN_BINDINGS(mud_gltf)
{
    ...
    value_object<glTF>("glTF")
        .field("buffers", &glTF::m_buffers)
        .field("buffer_views", &glTF::m_buffer_views)
        .field("accessors", &glTF::m_accessors)
        .field("images", &glTF::m_images)
        .field("textures", &glTF::m_textures)
        .field("materials", &glTF::m_materials)
        .field("meshes", &glTF::m_meshes)
        .field("nodes", &glTF::m_nodes)
        .field("skins", &glTF::m_skins)
        .field("animations", &glTF::m_animations)
        .field("cameras", &glTF::m_cameras)
        .field("samplers", &glTF::m_samplers)
        .field("scenes", &glTF::m_scenes)
        ;
