...
EMSCRIPTEN_BINDINGS(mud_ctx)
{
    ...
    value_object<mud::InputEvent>("InputEvent")
        .field("deviceType", &mud::InputEvent::deviceType)
        .field("eventType", &mud::InputEvent::eventType)
        .field("receiver", &mud::InputEvent::receiver)
        .field("consumer", &mud::InputEvent::consumer)
        .field("abort", &mud::InputEvent::abort)
        .field("modifiers", &mud::InputEvent::modifiers)
        .field("key", &mud::InputEvent::key)
        ;
    value_object<mud::KeyEvent>("KeyEvent")
        .field("code", &mud::KeyEvent::code)
        .field("char", &mud::KeyEvent::char)
        ;
    value_object<mud::MouseEvent>("MouseEvent")
        .field("pos", &mud::MouseEvent::pos)
        .field("relative", &mud::MouseEvent::relative)
        .field("delta", &mud::MouseEvent::delta)
        .field("deltaZ", &mud::MouseEvent::deltaZ)
        .field("pressed", &mud::MouseEvent::pressed)
        .field("button", &mud::MouseEvent::button)
        ;
    
    // Classes
    class_<mud::Context>("Context")
        .property("resource_path", &mud::Context::resource_path)
        .property("title", &mud::Context::title)
        .property("width", &mud::Context::width)
        .property("height", &mud::Context::height)
        .property("full_screen", &mud::Context::full_screen)
        .property("active", &mud::Context::active)
        .property("shutdown", &mud::Context::shutdown)
        .property("cursor", &mud::Context::cursor)
        .property("mouse_lock", &mud::Context::mouse_lock)
