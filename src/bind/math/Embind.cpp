...
EMSCRIPTEN_BINDINGS(mud_math)
{
    ...
    value_array<mud::Colour>("Colour")
        .element(&mud::Colour::r)
        .element(&mud::Colour::g)
        .element(&mud::Colour::b)
        .element(&mud::Colour::a)
        ;
    ...
    value_object<mud::Image256>("Image256")
        .field("pixels", &mud::Image256::pixels)
        .field("width", &mud::Image256::width)
        .field("height", &mud::Image256::height)
        .field("palette", &mud::Image256::palette)
        ;
    value_object<mud::Palette>("Palette")
        ;
    value_object<mud::Range<float>>("Range<float>")
        .field("min", &mud::Range<float>::min)
        .field("max", &mud::Range<float>::max)
        ;
    value_object<mud::Range<mud::Colour>>("Range<mud::Colour>")
        .field("min", &mud::Range<mud::Colour>::min)
        .field("max", &mud::Range<mud::Colour>::max)
        ;
    value_object<mud::Range<mud::quat>>("Range<mud::quat>")
        .field("min", &mud::Range<mud::quat>::min)
        .field("max", &mud::Range<mud::quat>::max)
        ;
    value_object<mud::Range<mud::vec3>>("Range<mud::vec3>")
        .field("min", &mud::Range<mud::vec3>::min)
        .field("max", &mud::Range<mud::vec3>::max)
        ;
    value_object<mud::Range<uint32_t>>("Range<uint32_t>")
        .field("min", &mud::Range<uint32_t>::min)
        .field("max", &mud::Range<uint32_t>::max)
        ;
    value_object<mud::Ratio>("Ratio")
        ;
    value_object<mud::Time>("Time")
        .field("value", &mud::Time::value)
        ;
    ...
    value_object<mud::Transform>("Transform")
        .field("position", &mud::Transform::position)
        .field("rotation", &mud::Transform::rotation)
        .field("scale", &mud::Transform::scale)
        ;
    value_object<mud::ValueCurve<float>>("ValueCurve<float>")
        .field("keys", &mud::ValueCurve<float>::keys)
        ;
    value_object<mud::ValueCurve<mud::Colour>>("ValueCurve<mud::Colour>")
        .field("keys", &mud::ValueCurve<mud::Colour>::keys)
        ;
    value_object<mud::ValueCurve<mud::quat>>("ValueCurve<mud::quat>")
        .field("keys", &mud::ValueCurve<mud::quat>::keys)
        ;
    value_object<mud::ValueCurve<mud::vec3>>("ValueCurve<mud::vec3>")
        .field("keys", &mud::ValueCurve<mud::vec3>::keys)
        ;
    value_object<mud::ValueCurve<uint32_t>>("ValueCurve<uint32_t>")
        .field("keys", &mud::ValueCurve<uint32_t>::keys)
        ;
    value_object<mud::ValueTrack<float>>("ValueTrack<float>")
        .field("mode", &mud::ValueTrack<float>::mode)
        .field("value", &mud::ValueTrack<float>::value)
        .field("min", &mud::ValueTrack<float>::min)
        .field("max", &mud::ValueTrack<float>::max)
        .field("curve", &mud::ValueTrack<float>::curve)
        .field("min_curve", &mud::ValueTrack<float>::min_curve)
        .field("max_curve", &mud::ValueTrack<float>::max_curve)
        ;
    value_object<mud::ValueTrack<mud::Colour>>("ValueTrack<mud::Colour>")
        .field("mode", &mud::ValueTrack<mud::Colour>::mode)
        .field("value", &mud::ValueTrack<mud::Colour>::value)
        .field("min", &mud::ValueTrack<mud::Colour>::min)
        .field("max", &mud::ValueTrack<mud::Colour>::max)
        .field("curve", &mud::ValueTrack<mud::Colour>::curve)
        .field("min_curve", &mud::ValueTrack<mud::Colour>::min_curve)
        .field("max_curve", &mud::ValueTrack<mud::Colour>::max_curve)
        ;
    value_object<mud::ValueTrack<mud::quat>>("ValueTrack<mud::quat>")
        .field("mode", &mud::ValueTrack<mud::quat>::mode)
        .field("value", &mud::ValueTrack<mud::quat>::value)
        .field("min", &mud::ValueTrack<mud::quat>::min)
        .field("max", &mud::ValueTrack<mud::quat>::max)
        .field("curve", &mud::ValueTrack<mud::quat>::curve)
        .field("min_curve", &mud::ValueTrack<mud::quat>::min_curve)
        .field("max_curve", &mud::ValueTrack<mud::quat>::max_curve)
        ;
    value_object<mud::ValueTrack<mud::vec3>>("ValueTrack<mud::vec3>")
        .field("mode", &mud::ValueTrack<mud::vec3>::mode)
        .field("value", &mud::ValueTrack<mud::vec3>::value)
        .field("min", &mud::ValueTrack<mud::vec3>::min)
        .field("max", &mud::ValueTrack<mud::vec3>::max)
        .field("curve", &mud::ValueTrack<mud::vec3>::curve)
        .field("min_curve", &mud::ValueTrack<mud::vec3>::min_curve)
        .field("max_curve", &mud::ValueTrack<mud::vec3>::max_curve)
        ;
    value_object<mud::ValueTrack<uint32_t>>("ValueTrack<uint32_t>")
        .field("mode", &mud::ValueTrack<uint32_t>::mode)
        .field("value", &mud::ValueTrack<uint32_t>::value)
        .field("min", &mud::ValueTrack<uint32_t>::min)
        .field("max", &mud::ValueTrack<uint32_t>::max)
        .field("curve", &mud::ValueTrack<uint32_t>::curve)
        .field("min_curve", &mud::ValueTrack<uint32_t>::min_curve)
        .field("max_curve", &mud::ValueTrack<uint32_t>::max_curve)
        ;
