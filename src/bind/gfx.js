...
AssetStore_mud_Flow.prototype.__class__ = AssetStore_mud_Flow;
AssetStore_mud_Flow.__cache__ = {};
...
AssetStore_mud_Flow.prototype["get"] = AssetStore_mud_Flow.prototype.get = function(a0) {
    var self = this.ptr;
    ensureCache.prepare();
    return wrapPointer(_mud_AssetStore_mud_Flow_get_1(self, ensureString(/*name*/a0)), Flow);
};
AssetStore_mud_Flow.prototype["create"] = AssetStore_mud_Flow.prototype.create = function(a0) {
    var self = this.ptr;
    ensureCache.prepare();
    return wrapPointer(_mud_AssetStore_mud_Flow_create_1(self, ensureString(/*name*/a0)), Flow);
};
AssetStore_mud_Flow.prototype["fetch"] = AssetStore_mud_Flow.prototype.fetch = function(a0) {
    var self = this.ptr;
    ensureCache.prepare();
    return wrapPointer(_mud_AssetStore_mud_Flow_fetch_1(self, ensureString(/*name*/a0)), Flow);
};
AssetStore_mud_Flow.prototype["file"] = AssetStore_mud_Flow.prototype.file = function(a0) {
    var self = this.ptr;
    ensureCache.prepare();
    return wrapPointer(_mud_AssetStore_mud_Flow_file_1(self, ensureString(/*name*/a0)), Flow);
};
AssetStore_mud_Flow.prototype["file_at"] = AssetStore_mud_Flow.prototype.file_at = function(a0, a1) {
    var self = this.ptr;
    ensureCache.prepare();
    return wrapPointer(_mud_AssetStore_mud_Flow_file_at_2(self, ensureString(/*path*/a0), ensureString(/*name*/a1)), Flow);
};
AssetStore_mud_Flow.prototype["destroy"] = AssetStore_mud_Flow.prototype.destroy = function(a0) {
    var self = this.ptr;
    ensureCache.prepare();
    _mud_AssetStore_mud_Flow_destroy_1(self, ensureString(/*name*/a0));
};
AssetStore_mud_Flow.prototype["__destroy__"] = AssetStore_mud_Flow.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_AssetStore_mud_Flow__destroy(self);
};
...
// Batch
function Batch(a0) {
    if (a0 === undefined) { this.ptr = _mud_Batch__construct_0(); this.type = Batch; getCache(Batch)[this.ptr] = this; return; }
    this.ptr = _mud_Batch__construct_1(/*item*/a0.ptr); this.type = Batch; getCache(Batch)[this.ptr] = this;
};
...
Object.defineProperty(Batch.prototype, "item", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Batch__get_item(self), Item);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Batch__set_item(self, value.ptr);
    }
});
Batch.prototype["__destroy__"] = Batch.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_Batch__destroy(self);
};
// Bone
function Bone() {
...
Object.defineProperty(DepthParams.prototype, "depth_bias", {
    get: function() {
        var self = this.ptr;
        return _mud_DepthParams__get_depth_bias(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_DepthParams__set_depth_bias(self, value);
    }
});
Object.defineProperty(DepthParams.prototype, "depth_normal_bias", {
    get: function() {
        var self = this.ptr;
        return _mud_DepthParams__get_depth_normal_bias(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_DepthParams__set_depth_normal_bias(self, value);
    }
});
Object.defineProperty(DepthParams.prototype, "depth_z_far", {
    get: function() {
        var self = this.ptr;
        return _mud_DepthParams__get_depth_z_far(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_DepthParams__set_depth_z_far(self, value);
    }
});
...
function Direct(a0, a1) {
    if (a0 === undefined) { this.ptr = _mud_Direct__construct_0(); this.type = Direct; getCache(Direct)[this.ptr] = this; return; }
    this.ptr = _mud_Direct__construct_2(/*node*/a0.ptr, /*material*/a1.ptr); this.type = Direct; getCache(Direct)[this.ptr] = this;
};
Direct.prototype = Object.create(WrapperObject.prototype);
Direct.prototype.constructor = Direct;
Direct.prototype.__class__ = Direct;
Direct.__cache__ = {};
Module['Direct'] = Direct;
Object.defineProperty(Direct.prototype, "node", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Direct__get_node(self), Node3);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Direct__set_node(self, value.ptr);
    }
});
Object.defineProperty(Direct.prototype, "material", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Direct__get_material(self), Material);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Direct__set_material(self, value.ptr);
    }
});
Direct.prototype["__destroy__"] = Direct.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_Direct__destroy(self);
};
// DistanceParams
function DistanceParams() {
    this.ptr = _mud_DistanceParams__construct_0(); this.type = DistanceParams; getCache(DistanceParams)[this.ptr] = this;
};
DistanceParams.prototype = Object.create(WrapperObject.prototype);
DistanceParams.prototype.constructor = DistanceParams;
DistanceParams.prototype.__class__ = DistanceParams;
DistanceParams.__cache__ = {};
Module['DistanceParams'] = DistanceParams;
Object.defineProperty(DistanceParams.prototype, "eye", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_DistanceParams__get_eye(self), v3_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_DistanceParams__set_eye(self, value.ptr);
    }
});
Object.defineProperty(DistanceParams.prototype, "near", {
    get: function() {
        var self = this.ptr;
        return _mud_DistanceParams__get_near(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_DistanceParams__set_near(self, value);
    }
});
Object.defineProperty(DistanceParams.prototype, "far", {
    get: function() {
        var self = this.ptr;
        return _mud_DistanceParams__get_far(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_DistanceParams__set_far(self, value);
    }
});
DistanceParams.prototype["__destroy__"] = DistanceParams.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_DistanceParams__destroy(self);
};
// Filter
...
// Flow
function Flow() {
    this.ptr = _mud_Flow__construct_0(); this.type = Flow; getCache(Flow)[this.ptr] = this;
};
Flow.prototype = Object.create(WrapperObject.prototype);
Flow.prototype.constructor = Flow;
Flow.prototype.__class__ = Flow;
Flow.__cache__ = {};
Module['Flow'] = Flow;
Object.defineProperty(Flow.prototype, "name", {
    get: function() {
        var self = this.ptr;
        return Pointer_stringify(_mud_Flow__get_name(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_name(self, ensureString(value));
    }
});
Object.defineProperty(Flow.prototype, "duration", {
    get: function() {
        var self = this.ptr;
        return _mud_Flow__get_duration(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_duration(self, value);
    }
});
Object.defineProperty(Flow.prototype, "start_time", {
    get: function() {
        var self = this.ptr;
        return _mud_Flow__get_start_time(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_start_time(self, value);
    }
});
Object.defineProperty(Flow.prototype, "loop", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_Flow__get_loop(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_loop(self, value);
    }
});
Object.defineProperty(Flow.prototype, "shape", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_shape(self), ShapeVar);
    }});
Object.defineProperty(Flow.prototype, "flow", {
    get: function() {
        var self = this.ptr;
        return _mud_Flow__get_flow(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_flow(self, value);
    }
});
Object.defineProperty(Flow.prototype, "billboard", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_Flow__get_billboard(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_billboard(self, value);
    }
});
Object.defineProperty(Flow.prototype, "direction", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_direction(self), v3_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_direction(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "rotation", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_rotation(self), quat);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_rotation(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "blend_mode", {
    get: function() {
        var self = this.ptr;
        return _mud_Flow__get_blend_mode(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_blend_mode(self, value);
    }
});
Object.defineProperty(Flow.prototype, "volume", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_volume(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_volume(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "rate", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_rate(self), ValueTrack_uint32_t);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_rate(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "lifetime", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_lifetime(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_lifetime(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "gravity", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_gravity(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_gravity(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "speed", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_speed(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_speed(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "angle", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_angle(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_angle(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "blend", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_blend(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_blend(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "colour", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_colour(self), ValueTrack_mud_Colour);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_colour(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "scale", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_scale(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_scale(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "sprite_frame", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flow__get_sprite_frame(self), ValueTrack_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_sprite_frame(self, value.ptr);
    }
});
Object.defineProperty(Flow.prototype, "sprite_name", {
    get: function() {
        var self = this.ptr;
        return Pointer_stringify(_mud_Flow__get_sprite_name(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flow__set_sprite_name(self, ensureString(value));
    }
});
Flow.prototype["__destroy__"] = Flow.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_Flow__destroy(self);
};
// Fog
function Fog() {
...
GfxSystem.prototype["shape"] = GfxSystem.prototype.shape = function(a0, a1, a2) {
    var self = this.ptr;
    if (a1 === undefined) { return wrapPointer(_mud_GfxSystem_shape_1(self, /*shape*/a0.ptr), Model); }
    if (a2 === undefined) { return wrapPointer(_mud_GfxSystem_shape_2(self, /*shape*/a0.ptr, /*symbol*/a1.ptr), Model); }
    return wrapPointer(_mud_GfxSystem_shape_3(self, /*shape*/a0.ptr, /*symbol*/a1.ptr, /*draw_mode*/a2), Model);
};
GfxSystem.prototype["symbol_material"] = GfxSystem.prototype.symbol_material = function(a0, a1) {
    var self = this.ptr;
    return wrapPointer(_mud_GfxSystem_symbol_material_2(self, /*symbol*/a0.ptr, /*draw_mode*/a1), Material);
};
...
Object.defineProperty(GfxSystem.prototype, "flows", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_GfxSystem__get_flows(self), AssetStore_mud_Flow);
    }});
...
function Item(a0, a1, a2, a3) {
    if (a0 === undefined) { this.ptr = _mud_Item__construct_0(); this.type = Item; getCache(Item)[this.ptr] = this; return; }
    if (a2 === undefined) { this.ptr = _mud_Item__construct_2(/*node*/a0.ptr, /*model*/a1.ptr); this.type = Item; getCache(Item)[this.ptr] = this; return; }
    if (a3 === undefined) { this.ptr = _mud_Item__construct_3(/*node*/a0.ptr, /*model*/a1.ptr, /*flags*/a2); this.type = Item; getCache(Item)[this.ptr] = this; return; }
    this.ptr = _mud_Item__construct_4(/*node*/a0.ptr, /*model*/a1.ptr, /*flags*/a2, /*material*/a3.ptr); this.type = Item; getCache(Item)[this.ptr] = this;
};
...
Object.defineProperty(Material.prototype, "base", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_base(self), MaterialBase);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_base(self, value.ptr);
    }
});
Object.defineProperty(Material.prototype, "alpha", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_alpha(self), MaterialAlpha);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_alpha(self, value.ptr);
    }
});
Object.defineProperty(Material.prototype, "solid", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_solid(self), MaterialSolid);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_solid(self, value.ptr);
    }
});
Object.defineProperty(Material.prototype, "point", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_point(self), MaterialPoint);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_point(self, value.ptr);
    }
});
Object.defineProperty(Material.prototype, "line", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_line(self), MaterialLine);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_line(self, value.ptr);
    }
});
Object.defineProperty(Material.prototype, "pbr", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_pbr(self), MaterialPbr);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_pbr(self, value.ptr);
    }
});
Object.defineProperty(Material.prototype, "fresnel", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Material__get_fresnel(self), MaterialFresnel);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Material__set_fresnel(self, value.ptr);
    }
});
...
function MaterialAlpha() {
    this.ptr = _mud_MaterialAlpha__construct_0(); this.type = MaterialAlpha; getCache(MaterialAlpha)[this.ptr] = this;
};
MaterialAlpha.prototype = Object.create(WrapperObject.prototype);
MaterialAlpha.prototype.constructor = MaterialAlpha;
MaterialAlpha.prototype.__class__ = MaterialAlpha;
MaterialAlpha.__cache__ = {};
Module['MaterialAlpha'] = MaterialAlpha;
Object.defineProperty(MaterialAlpha.prototype, "alpha", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_MaterialAlpha__get_alpha(self), MaterialParam_float);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialAlpha__set_alpha(self, value.ptr);
    }
});
Object.defineProperty(MaterialAlpha.prototype, "alpha_scissor", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialAlpha__get_alpha_scissor(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialAlpha__set_alpha_scissor(self, value);
    }
});
Object.defineProperty(MaterialAlpha.prototype, "alpha_test", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_MaterialAlpha__get_alpha_test(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialAlpha__set_alpha_test(self, value);
    }
});
Object.defineProperty(MaterialAlpha.prototype, "is_alpha", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_MaterialAlpha__get_is_alpha(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialAlpha__set_is_alpha(self, value);
    }
});
MaterialAlpha.prototype["__destroy__"] = MaterialAlpha.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_MaterialAlpha__destroy(self);
};
// MaterialBase
...
Object.defineProperty(MaterialBase.prototype, "depth_draw", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialBase__get_depth_draw(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialBase__set_depth_draw(self, value);
    }
});
...
Object.defineProperty(MaterialBase.prototype, "shader_color", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialBase__get_shader_color(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialBase__set_shader_color(self, value);
    }
});
...
Object.defineProperty(MaterialBase.prototype, "anisotropy", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialBase__get_anisotropy(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialBase__set_anisotropy(self, value);
    }
});
...
function MaterialLine() {
    this.ptr = _mud_MaterialLine__construct_0(); this.type = MaterialLine; getCache(MaterialLine)[this.ptr] = this;
};
MaterialLine.prototype = Object.create(WrapperObject.prototype);
MaterialLine.prototype.constructor = MaterialLine;
MaterialLine.prototype.__class__ = MaterialLine;
MaterialLine.__cache__ = {};
Module['MaterialLine'] = MaterialLine;
Object.defineProperty(MaterialLine.prototype, "line_width", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialLine__get_line_width(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialLine__set_line_width(self, value);
    }
});
Object.defineProperty(MaterialLine.prototype, "dashed", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_MaterialLine__get_dashed(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialLine__set_dashed(self, value);
    }
});
Object.defineProperty(MaterialLine.prototype, "dash_scale", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialLine__get_dash_scale(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialLine__set_dash_scale(self, value);
    }
});
Object.defineProperty(MaterialLine.prototype, "dash_size", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialLine__get_dash_size(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialLine__set_dash_size(self, value);
    }
});
Object.defineProperty(MaterialLine.prototype, "dash_gap", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialLine__get_dash_gap(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialLine__set_dash_gap(self, value);
    }
});
MaterialLine.prototype["__destroy__"] = MaterialLine.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_MaterialLine__destroy(self);
};
// MaterialParam<float>
...
Object.defineProperty(MaterialPbr.prototype, "scene_environment", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_MaterialPbr__get_scene_environment(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialPbr__set_scene_environment(self, value);
    }
});
...
function MaterialPoint() {
    this.ptr = _mud_MaterialPoint__construct_0(); this.type = MaterialPoint; getCache(MaterialPoint)[this.ptr] = this;
};
MaterialPoint.prototype = Object.create(WrapperObject.prototype);
MaterialPoint.prototype.constructor = MaterialPoint;
MaterialPoint.prototype.__class__ = MaterialPoint;
MaterialPoint.__cache__ = {};
Module['MaterialPoint'] = MaterialPoint;
Object.defineProperty(MaterialPoint.prototype, "point_size", {
    get: function() {
        var self = this.ptr;
        return _mud_MaterialPoint__get_point_size(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialPoint__set_point_size(self, value);
    }
});
Object.defineProperty(MaterialPoint.prototype, "project", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_MaterialPoint__get_project(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialPoint__set_project(self, value);
    }
});
MaterialPoint.prototype["__destroy__"] = MaterialPoint.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_MaterialPoint__destroy(self);
};
// MaterialSolid
function MaterialSolid() {
    this.ptr = _mud_MaterialSolid__construct_0(); this.type = MaterialSolid; getCache(MaterialSolid)[this.ptr] = this;
};
MaterialSolid.prototype = Object.create(WrapperObject.prototype);
MaterialSolid.prototype.constructor = MaterialSolid;
MaterialSolid.prototype.__class__ = MaterialSolid;
MaterialSolid.__cache__ = {};
Module['MaterialSolid'] = MaterialSolid;
Object.defineProperty(MaterialSolid.prototype, "colour", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_MaterialSolid__get_colour(self), MaterialParam_mud_Colour);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_MaterialSolid__set_colour(self, value.ptr);
    }
});
MaterialSolid.prototype["__destroy__"] = MaterialSolid.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_MaterialSolid__destroy(self);
};
// Mesh
...
Object.defineProperty(Mesh.prototype, "primitive", {
    get: function() {
        var self = this.ptr;
        return _mud_Mesh__get_primitive(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Mesh__set_primitive(self, value);
    }
});
...
Object.defineProperty(Mesh.prototype, "is_dynamic", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_Mesh__get_is_dynamic(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Mesh__set_is_dynamic(self, value);
    }
});
Object.defineProperty(Mesh.prototype, "is_direct", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_Mesh__get_is_direct(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Mesh__set_is_direct(self, value);
    }
});
...
Mime.prototype.__class__ = Mime;
Mime.__cache__ = {};
Module['Mime'] = Mime;
Mime.prototype["start"] = Mime.prototype.start = function(a0, a1, a2, a3, a4) {
    var self = this.ptr;
    ensureCache.prepare();
    if (a2 === undefined) { _mud_Mime_start_2(self, ensureString(/*animation*/a0), /*loop*/a1); return; }
    if (a3 === undefined) { _mud_Mime_start_3(self, ensureString(/*animation*/a0), /*loop*/a1, /*blend*/a2); return; }
    if (a4 === undefined) { _mud_Mime_start_4(self, ensureString(/*animation*/a0), /*loop*/a1, /*blend*/a2, /*speed*/a3); return; }
    _mud_Mime_start_5(self, ensureString(/*animation*/a0), /*loop*/a1, /*blend*/a2, /*speed*/a3, /*transient*/a4);
};
Mime.prototype["play"] = Mime.prototype.play = function(a0, a1, a2, a3, a4) {
    var self = this.ptr;
    if (a2 === undefined) { _mud_Mime_play_2(self, /*animation*/a0.ptr, /*loop*/a1); return; }
    if (a3 === undefined) { _mud_Mime_play_3(self, /*animation*/a0.ptr, /*loop*/a1, /*blend*/a2); return; }
    if (a4 === undefined) { _mud_Mime_play_4(self, /*animation*/a0.ptr, /*loop*/a1, /*blend*/a2, /*speed*/a3); return; }
    _mud_Mime_play_5(self, /*animation*/a0.ptr, /*loop*/a1, /*blend*/a2, /*speed*/a3, /*transient*/a4);
};
Mime.prototype["seek"] = Mime.prototype.seek = function(a0) {
    var self = this.ptr;
    _mud_Mime_seek_1(self, /*time*/a0);
};
Mime.prototype["pause"] = Mime.prototype.pause = function() {
    var self = this.ptr;
    _mud_Mime_pause_0(self);
};
Mime.prototype["stop"] = Mime.prototype.stop = function() {
    var self = this.ptr;
    _mud_Mime_stop_0(self);
};
Mime.prototype["advance"] = Mime.prototype.advance = function(a0) {
    var self = this.ptr;
    _mud_Mime_advance_1(self, /*time*/a0);
};
Mime.prototype["next_animation"] = Mime.prototype.next_animation = function() {
    var self = this.ptr;
    _mud_Mime_next_animation_0(self);
};
Mime.prototype["playing"] = Mime.prototype.playing = function() {
    var self = this.ptr;
    return Pointer_stringify(_mud_Mime_playing_0(self));
};
Object.defineProperty(Mime.prototype, "active", {
    get: function() {
        var self = this.ptr;
        return !!(_mud_Mime__get_active(self));
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Mime__set_active(self, value);
    }
});
Object.defineProperty(Mime.prototype, "speed_scale", {
    get: function() {
        var self = this.ptr;
        return _mud_Mime__get_speed_scale(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Mime__set_speed_scale(self, value);
    }
});
Object.defineProperty(Mime.prototype, "default_blend_time", {
    get: function() {
        var self = this.ptr;
        return _mud_Mime__get_default_blend_time(self);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Mime__set_default_blend_time(self, value);
    }
});
Mime.prototype["__destroy__"] = Mime.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_Mime__destroy(self);
};
// Model
...
Node3.prototype["axis"] = Node3.prototype.axis = function(a0) {
    var self = this.ptr;
    return wrapPointer(_mud_Node3_axis_1(self, /*dir*/a0.ptr), v3_float);
};
Node3.prototype["direction"] = Node3.prototype.direction = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Node3_direction_0(self), v3_float);
};
...
// Scene
function Scene(a0) {
    this.ptr = _mud_Scene__construct_1(/*gfx*/a0.ptr); this.type = Scene; getCache(Scene)[this.ptr] = this;
};
...
Scene.prototype["nodes"] = Scene.prototype.nodes = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_nodes_0(self), TPool_mud_Node3);
};
Scene.prototype["items"] = Scene.prototype.items = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_items_0(self), TPool_mud_Item);
};
Scene.prototype["batches"] = Scene.prototype.batches = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_batches_0(self), TPool_mud_Batch);
};
Scene.prototype["directs"] = Scene.prototype.directs = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_directs_0(self), TPool_mud_Direct);
};
Scene.prototype["mimes"] = Scene.prototype.mimes = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_mimes_0(self), TPool_mud_Mime);
};
Scene.prototype["lights"] = Scene.prototype.lights = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_lights_0(self), TPool_mud_Light);
};
Scene.prototype["flares"] = Scene.prototype.flares = function() {
    var self = this.ptr;
    return wrapPointer(_mud_Scene_flares_0(self), TPool_mud_Flare);
};
...
Object.defineProperty(Scene.prototype, "env", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Scene__get_env(self), Zone);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Scene__set_env(self, value.ptr);
    }
});
...
TPool_mud_Batch.prototype.__class__ = TPool_mud_Batch;
TPool_mud_Batch.__cache__ = {};
Module['TPool_mud_Batch'] = TPool_mud_Batch;
TPool_mud_Batch.prototype["add"] = TPool_mud_Batch.prototype.add = function(a0) {
    var self = this.ptr;
    return wrapPointer(_mud_TPool_mud_Batch_add_1(self, /*value*/a0.ptr), Batch);
};
TPool_mud_Batch.prototype["talloc"] = TPool_mud_Batch.prototype.talloc = function() {
    var self = this.ptr;
    return wrapPointer(_mud_TPool_mud_Batch_talloc_0(self), Batch);
};
TPool_mud_Batch.prototype["tdestroy"] = TPool_mud_Batch.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Batch_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Batch.prototype["tfree"] = TPool_mud_Batch.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Batch_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Batch.prototype["__destroy__"] = TPool_mud_Batch.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Batch__destroy(self);
};
// TPool<mud::Direct>
...
TPool_mud_Direct.prototype.__class__ = TPool_mud_Direct;
TPool_mud_Direct.__cache__ = {};
Module['TPool_mud_Direct'] = TPool_mud_Direct;
TPool_mud_Direct.prototype["add"] = TPool_mud_Direct.prototype.add = function(a0) {
    var self = this.ptr;
    return wrapPointer(_mud_TPool_mud_Direct_add_1(self, /*value*/a0.ptr), Direct);
};
TPool_mud_Direct.prototype["talloc"] = TPool_mud_Direct.prototype.talloc = function() {
    var self = this.ptr;
    return wrapPointer(_mud_TPool_mud_Direct_talloc_0(self), Direct);
};
TPool_mud_Direct.prototype["tdestroy"] = TPool_mud_Direct.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Direct_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Direct.prototype["tfree"] = TPool_mud_Direct.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Direct_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Direct.prototype["__destroy__"] = TPool_mud_Direct.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Direct__destroy(self);
};
// TPool<mud::Flare>
...
TPool_mud_Flare.prototype["tdestroy"] = TPool_mud_Flare.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Flare_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Flare.prototype["tfree"] = TPool_mud_Flare.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Flare_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Flare.prototype["__destroy__"] = TPool_mud_Flare.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Flare__destroy(self);
};
// TPool<mud::Item>
...
TPool_mud_Item.prototype["tdestroy"] = TPool_mud_Item.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Item_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Item.prototype["tfree"] = TPool_mud_Item.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Item_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Item.prototype["__destroy__"] = TPool_mud_Item.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Item__destroy(self);
};
// TPool<mud::Light>
...
TPool_mud_Light.prototype["tdestroy"] = TPool_mud_Light.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Light_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Light.prototype["tfree"] = TPool_mud_Light.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Light_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Light.prototype["__destroy__"] = TPool_mud_Light.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Light__destroy(self);
};
// TPool<mud::Mime>
...
TPool_mud_Mime.prototype["tdestroy"] = TPool_mud_Mime.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Mime_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Mime.prototype["tfree"] = TPool_mud_Mime.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Mime_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Mime.prototype["__destroy__"] = TPool_mud_Mime.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Mime__destroy(self);
};
// TPool<mud::Node3>
...
TPool_mud_Node3.prototype["tdestroy"] = TPool_mud_Node3.prototype.tdestroy = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Node3_tdestroy_1(self, /*object*/a0.ptr);
};
TPool_mud_Node3.prototype["tfree"] = TPool_mud_Node3.prototype.tfree = function(a0) {
    var self = this.ptr;
    _mud_TPool_mud_Node3_tfree_1(self, /*object*/a0.ptr);
};
TPool_mud_Node3.prototype["__destroy__"] = TPool_mud_Node3.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_TPool_mud_Node3__destroy(self);
};
// Texture
...
BlockMaterial.prototype.__class__ = BlockMaterial;
BlockMaterial.__cache__ = {};
Module['BlockMaterial'] = BlockMaterial;
BlockMaterial.prototype["__destroy__"] = BlockMaterial.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_BlockMaterial__destroy(self);
};
// BlockParticles
...
// Flare
function Flare() {
    this.ptr = _mud_Flare__construct_0(); this.type = Flare; getCache(Flare)[this.ptr] = this;
};
Flare.prototype = Object.create(Flow.prototype);
Flare.prototype.constructor = Flare;
Flare.prototype.__class__ = Flare;
Flare.__cache__ = {};
Module['Flare'] = Flare;
Object.defineProperty(Flare.prototype, "node", {
    get: function() {
        var self = this.ptr;
        return wrapPointer(_mud_Flare__get_node(self), Node3);
    },
    set: function(value) {
        var self = this.ptr;
        _mud_Flare__set_node(self, value.ptr);
    }
});
Flare.prototype["__destroy__"] = Flare.prototype.__destroy__ = function() {
    var self = this.ptr;
    _mud_Flare__destroy(self);
};
// RenderTarget
...
Module['gfx']['shape'] = function(a0, a1, a2, a3, a4) {
    ...
    return wrapPointer(_mud_gfx_shape_5(/*parent*/a0.ptr, /*shape*/a1.ptr, /*symbol*/a2.ptr, /*flags*/a3, /*material*/a4.ptr), Item);
};
...
Module['gfx']['sprite'] = function(a0, a1, a2, a3, a4) {
    ...
    return wrapPointer(_mud_gfx_sprite_5(/*parent*/a0.ptr, /*image*/a1.ptr, /*size*/a2.ptr, /*flags*/a3, /*material*/a4.ptr), Item);
};
Module['gfx']['item'] = function(a0, a1, a2, a3) {
    if (a2 === undefined) { return wrapPointer(_mud_gfx_item_2(/*parent*/a0.ptr, /*model*/a1.ptr), Item); }
    if (a3 === undefined) { return wrapPointer(_mud_gfx_item_3(/*parent*/a0.ptr, /*model*/a1.ptr, /*flags*/a2), Item); }
    return wrapPointer(_mud_gfx_item_4(/*parent*/a0.ptr, /*model*/a1.ptr, /*flags*/a2, /*material*/a3.ptr), Item);
};
...
Module['gfx']['prefab'] = function(a0, a1, a2, a3, a4) {
    ...
    if (a3 === undefined) { _mud_gfx_prefab_3(/*parent*/a0.ptr, /*prefab*/a1.ptr, /*transform*/a2); return; }
    if (a4 === undefined) { _mud_gfx_prefab_4(/*parent*/a0.ptr, /*prefab*/a1.ptr, /*transform*/a2, /*flags*/a3); return; }
    _mud_gfx_prefab_5(/*parent*/a0.ptr, /*prefab*/a1.ptr, /*transform*/a2, /*flags*/a3, /*material*/a4.ptr);
};
Module['gfx']['model'] = function(a0, a1, a2, a3) {
    ...
    return wrapPointer(_mud_gfx_model_4(/*parent*/a0.ptr, ensureString(/*name*/a1), /*flags*/a2, /*material*/a3.ptr), Item);
};
Module['gfx']['animated'] = function(a0, a1) {
    return wrapPointer(_mud_gfx_animated_2(/*parent*/a0.ptr, /*item*/a1.ptr), Mime);
};
Module['gfx']['flows'] = function(a0, a1, a2) {
    if (a2 === undefined) { return wrapPointer(_mud_gfx_flows_2(/*parent*/a0.ptr, /*emitter*/a1.ptr), Flare); }
    return wrapPointer(_mud_gfx_flows_3(/*parent*/a0.ptr, /*emitter*/a1.ptr, /*flags*/a2), Flare);
};
...
Module['gfx']['solid_material'] = function(a0, a1, a2) {
    ensureCache.prepare();
    return wrapPointer(_mud_gfx_solid_material_3(/*gfx*/a0.ptr, ensureString(/*name*/a1), /*colour*/a2.ptr), Material);
};
...
(function() {
    function setup() {
        ...
        Batch.__type__ = _mud_Batch__type();
        ...
        Direct.__type__ = _mud_Direct__type();
        DistanceParams.__type__ = _mud_DistanceParams__type();
        ...
        MaterialAlpha.__type__ = _mud_MaterialAlpha__type();
        MaterialBase.__type__ = _mud_MaterialBase__type();
        MaterialFresnel.__type__ = _mud_MaterialFresnel__type();
        MaterialLine.__type__ = _mud_MaterialLine__type();
        MaterialPbr.__type__ = _mud_MaterialPbr__type();
        MaterialPoint.__type__ = _mud_MaterialPoint__type();
        MaterialSolid.__type__ = _mud_MaterialSolid__type();
        Mesh.__type__ = _mud_Mesh__type();
        Mime.__type__ = _mud_Mime__type();
        ...
        BlockMaterial.__type__ = _mud_BlockMaterial__type();
