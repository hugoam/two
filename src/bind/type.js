...
// Ref
function Ref(a0, a1) {
    if (a0 === undefined) { this.__ptr = _mud_Ref__construct_0(); this.__type = Ref.__type; getCache(Ref)[this.__ptr] = this; return; }
    this.__ptr = _mud_Ref__construct_2(/*value*/a0, /*type*/a1.__ptr); this.__type = Ref.__type; getCache(Ref)[this.__ptr] = this;
};
