...
ScriptError.prototype["__destroy"] = ScriptError.prototype.__destroy = function() {
    _two_ScriptError__destroy(this.__ptr);
};
// TextScript
function TextScript(a0, a1, a2) {
    ...
    if (a2 === undefined) { this.__ptr = _two_TextScript__construct_2(ensureString(/*name*/a0), /*language*/a1); getCache(TextScript)[this.__ptr] = this; }
    else { this.__ptr = _two_TextScript__construct_3(ensureString(/*name*/a0), /*language*/a1, /*signature*/a2.__ptr); getCache(TextScript)[this.__ptr] = this; }
};
...
Object.defineProperty(ScriptClass.prototype, "name", {
    get: function() {
        return UTF8ToString(_two_ScriptClass__get_name(this.__ptr));
    },
    set: function(value) {
        if (typeof value !== 'string') throw Error('ScriptClass.name: expected string');
        _two_ScriptClass__set_name(this.__ptr, ensureString(value));
    }
});
Object.defineProperty(ScriptClass.prototype, "class_type", {
    get: function() {
        return wrapPointer(_two_ScriptClass__get_class_type(this.__ptr), Type);
    }});
Object.defineProperty(ScriptClass.prototype, "class", {
    get: function() {
        return wrapPointer(_two_ScriptClass__get_class(this.__ptr), Class);
    }});
Object.defineProperty(ScriptClass.prototype, "prototype", {
    get: function() {
        return wrapPointer(_two_ScriptClass__get_prototype(this.__ptr), Prototype);
    }});
ScriptClass.prototype["__destroy"] = ScriptClass.prototype.__destroy = function() {
    _two_ScriptClass__destroy(this.__ptr);
};
// LuaInterpreter
...
LuaInterpreter.prototype["__destroy"] = LuaInterpreter.prototype.__destroy = function() {
    _two_LuaInterpreter__destroy(this.__ptr);
};
// StreamBranch
...
StreamBranch.prototype["__destroy"] = StreamBranch.prototype.__destroy = function() {
    _two_StreamBranch__destroy(this.__ptr);
};
// Stream
...
Stream.prototype["__destroy"] = Stream.prototype.__destroy = function() {
    _two_Stream__destroy(this.__ptr);
};
// Valve
...
Valve.prototype["__destroy"] = Valve.prototype.__destroy = function() {
    _two_Valve__destroy(this.__ptr);
};
// Pipe
...
Object.defineProperty(Process.prototype, "type", {
    get: function() {
        return wrapPointer(_two_Process__get_type(this.__ptr), Type);
    }});
Process.prototype["__destroy"] = Process.prototype.__destroy = function() {
    _two_Process__destroy(this.__ptr);
};
// VisualScript
function VisualScript(a0, a1) {
    ...
    if (a1 === undefined) { this.__ptr = _two_VisualScript__construct_1(ensureString(/*name*/a0)); getCache(VisualScript)[this.__ptr] = this; }
    else { this.__ptr = _two_VisualScript__construct_2(ensureString(/*name*/a0), /*signature*/a1.__ptr); getCache(VisualScript)[this.__ptr] = this; }
};
...
VisualScript.prototype["__destroy"] = VisualScript.prototype.__destroy = function() {
    _two_VisualScript__destroy(this.__ptr);
};
// ProcessInput
...
ProcessInput.prototype["__destroy"] = ProcessInput.prototype.__destroy = function() {
    _two_ProcessInput__destroy(this.__ptr);
};
// ProcessOutput
...
ProcessOutput.prototype["__destroy"] = ProcessOutput.prototype.__destroy = function() {
    _two_ProcessOutput__destroy(this.__ptr);
};
// ProcessValue
function ProcessValue(a0, a1) {
    ...
    this.__ptr = _two_ProcessValue__construct_2(/*script*/a0.__ptr, /*value*/a1.__ptr); getCache(ProcessValue)[this.__ptr] = this;
};
...
ProcessValue.prototype["__destroy"] = ProcessValue.prototype.__destroy = function() {
    _two_ProcessValue__destroy(this.__ptr);
};
// ProcessCreate
function ProcessCreate(a0, a1, a2) {
    ...
    this.__ptr = _two_ProcessCreate__construct_3(/*script*/a0.__ptr, /*type*/a1.__ptr, /*constructor*/a2.__ptr); getCache(ProcessCreate)[this.__ptr] = this;
};
...
ProcessCreate.prototype["__destroy"] = ProcessCreate.prototype.__destroy = function() {
    _two_ProcessCreate__destroy(this.__ptr);
};
// ProcessCallable
function ProcessCallable(a0, a1) {
    ...
    this.__ptr = _two_ProcessCallable__construct_2(/*script*/a0.__ptr, /*callable*/a1.__ptr); getCache(ProcessCallable)[this.__ptr] = this;
};
...
ProcessCallable.prototype["__destroy"] = ProcessCallable.prototype.__destroy = function() {
    _two_ProcessCallable__destroy(this.__ptr);
};
// ProcessScript
function ProcessScript(a0, a1) {
    ...
    this.__ptr = _two_ProcessScript__construct_2(/*script*/a0.__ptr, /*target*/a1.__ptr); getCache(ProcessScript)[this.__ptr] = this;
};
...
ProcessScript.prototype["__destroy"] = ProcessScript.prototype.__destroy = function() {
    _two_ProcessScript__destroy(this.__ptr);
};
// ProcessFunction
function ProcessFunction(a0, a1) {
    ...
    this.__ptr = _two_ProcessFunction__construct_2(/*script*/a0.__ptr, /*function*/a1.__ptr); getCache(ProcessFunction)[this.__ptr] = this;
};
...
ProcessFunction.prototype["__destroy"] = ProcessFunction.prototype.__destroy = function() {
    _two_ProcessFunction__destroy(this.__ptr);
};
// ProcessMethod
function ProcessMethod(a0, a1) {
    ...
    this.__ptr = _two_ProcessMethod__construct_2(/*script*/a0.__ptr, /*method*/a1.__ptr); getCache(ProcessMethod)[this.__ptr] = this;
};
...
ProcessMethod.prototype["__destroy"] = ProcessMethod.prototype.__destroy = function() {
    _two_ProcessMethod__destroy(this.__ptr);
};
// ProcessGetMember
function ProcessGetMember(a0, a1) {
    ...
    this.__ptr = _two_ProcessGetMember__construct_2(/*script*/a0.__ptr, /*member*/a1.__ptr); getCache(ProcessGetMember)[this.__ptr] = this;
};
...
ProcessGetMember.prototype["__destroy"] = ProcessGetMember.prototype.__destroy = function() {
    _two_ProcessGetMember__destroy(this.__ptr);
};
// ProcessSetMember
function ProcessSetMember(a0, a1) {
    ...
    this.__ptr = _two_ProcessSetMember__construct_2(/*script*/a0.__ptr, /*member*/a1.__ptr); getCache(ProcessSetMember)[this.__ptr] = this;
};
...
ProcessSetMember.prototype["__destroy"] = ProcessSetMember.prototype.__destroy = function() {
    _two_ProcessSetMember__destroy(this.__ptr);
};
// ProcessDisplay
...
ProcessDisplay.prototype["__destroy"] = ProcessDisplay.prototype.__destroy = function() {
    _two_ProcessDisplay__destroy(this.__ptr);
};
// WrenInterpreter
...
WrenInterpreter.prototype["__destroy"] = WrenInterpreter.prototype.__destroy = function() {
    _two_WrenInterpreter__destroy(this.__ptr);
};

(function() {
    function setup() {
        Script.prototype.__type = _two_Script__type();
        ScriptError.prototype.__type = _two_ScriptError__type();
        TextScript.prototype.__type = _two_TextScript__type();
        Interpreter.prototype.__type = _two_Interpreter__type();
        ScriptClass.prototype.__type = _two_ScriptClass__type();
        LuaInterpreter.prototype.__type = _two_LuaInterpreter__type();
        StreamBranch.prototype.__type = _two_StreamBranch__type();
        Stream.prototype.__type = _two_Stream__type();
        Valve.prototype.__type = _two_Valve__type();
        Pipe.prototype.__type = _two_Pipe__type();
        Process.prototype.__type = _two_Process__type();
        VisualScript.prototype.__type = _two_VisualScript__type();
        ProcessInput.prototype.__type = _two_ProcessInput__type();
        ProcessOutput.prototype.__type = _two_ProcessOutput__type();
        ProcessValue.prototype.__type = _two_ProcessValue__type();
        ProcessCreate.prototype.__type = _two_ProcessCreate__type();
        ProcessCallable.prototype.__type = _two_ProcessCallable__type();
        ProcessScript.prototype.__type = _two_ProcessScript__type();
        ProcessFunction.prototype.__type = _two_ProcessFunction__type();
        ProcessMethod.prototype.__type = _two_ProcessMethod__type();
        ProcessGetMember.prototype.__type = _two_ProcessGetMember__type();
        ProcessSetMember.prototype.__type = _two_ProcessSetMember__type();
        ProcessDisplay.prototype.__type = _two_ProcessDisplay__type();
        WrenInterpreter.prototype.__type = _two_WrenInterpreter__type();
        // Language
        Module['Language'] = Module['Language'] || {};
        Module['Language']['Cpp'] = _two_Language_Cpp();
        Module['Language']['Lua'] = _two_Language_Lua();
        Module['Language']['Wren'] = _two_Language_Wren();
    }
