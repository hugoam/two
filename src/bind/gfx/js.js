...
(function() {
    function setup() {
        ...
        AssetStore<mud::Material>.__type__ = _mud_AssetStore<mud_Material>__type();
        AssetStore<mud::Model>.__type__ = _mud_AssetStore<mud_Model>__type();
        AssetStore<mud::ParticleGenerator>.__type__ = _mud_AssetStore<mud_ParticleGenerator>__type();
        AssetStore<mud::Prefab>.__type__ = _mud_AssetStore<mud_Prefab>__type();
        AssetStore<mud::Program>.__type__ = _mud_AssetStore<mud_Program>__type();
        AssetStore<mud::Texture>.__type__ = _mud_AssetStore<mud_Texture>__type();
        ...
        MaterialParam<float>.__type__ = _mud_MaterialParam<float>__type();
        MaterialParam<mud::Colour>.__type__ = _mud_MaterialParam<mud_Colour>__type();
