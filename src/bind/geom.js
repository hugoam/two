...
function Aabb(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Aabb__construct_0(); getCache(Aabb)[this.__ptr] = this; }
    else { this.__ptr = _two_Aabb__construct_2(/*center*/a0.__ptr, /*extents*/a1.__ptr); getCache(Aabb)[this.__ptr] = this; }
};
...
Curve2.prototype["point"] = Curve2.prototype.point = function(a0) {
    ...
    return wrapPointer(_two_Curve2_point_1(this.__ptr, /*t*/a0), v2_float);
};
Curve2.prototype["__destroy"] = Curve2.prototype.__destroy = function() {
    _two_Curve2__destroy(this.__ptr);
};
// Curve3
...
Curve3.prototype["point"] = Curve3.prototype.point = function(a0) {
    if (typeof a0 !== 'number') throw Error('point(0:t): expected number');
    return wrapPointer(_two_Curve3_point_1(this.__ptr, /*t*/a0), v3_float);
};
Curve3.prototype["__destroy"] = Curve3.prototype.__destroy = function() {
    _two_Curve3__destroy(this.__ptr);
};
// CurveSpline
...
Object.defineProperty(CurveSpline.prototype, "points", {
    get: function() {
        return _two_CurveSpline__get_points(this.__ptr);
    }});
CurveSpline.prototype["__destroy"] = CurveSpline.prototype.__destroy = function() {
    _two_CurveSpline__destroy(this.__ptr);
};
// CurveSpline3
...
Object.defineProperty(CurveSpline3.prototype, "points", {
    get: function() {
        return _two_CurveSpline3__get_points(this.__ptr);
    }});
CurveSpline3.prototype["__destroy"] = CurveSpline3.prototype.__destroy = function() {
    _two_CurveSpline3__destroy(this.__ptr);
};
// CurveBezierCubic
...
Face3.prototype["__destroy"] = Face3.prototype.__destroy = function() {
    _two_Face3__destroy(this.__ptr);
};
// Segment
function Segment() {
...
MeshAdapter.prototype["copy"] = MeshAdapter.prototype.copy = function(a0) {
    ...
    _two_MeshAdapter_copy_1(this.__ptr, /*dest*/a0.__ptr);
};
...
MeshAdapter.prototype["position"] = MeshAdapter.prototype.position = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_position_1(this.__ptr, /*p*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["position4"] = MeshAdapter.prototype.position4 = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_position4_1(this.__ptr, /*p*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["normal"] = MeshAdapter.prototype.normal = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_normal_1(this.__ptr, /*n*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["colour"] = MeshAdapter.prototype.colour = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_colour_1(this.__ptr, /*c*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["tangent"] = MeshAdapter.prototype.tangent = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_tangent_1(this.__ptr, /*t*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["bitangent"] = MeshAdapter.prototype.bitangent = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_bitangent_1(this.__ptr, /*b*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["uv0"] = MeshAdapter.prototype.uv0 = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_uv0_1(this.__ptr, /*uv*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["uv1"] = MeshAdapter.prototype.uv1 = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_uv1_1(this.__ptr, /*uv*/a0.__ptr), MeshAdapter);
};
MeshAdapter.prototype["joints"] = MeshAdapter.prototype.joints = function(a0) {
    ...
    return wrapPointer(_two_MeshAdapter_joints_1(this.__ptr, /*j*/a0), MeshAdapter);
};
...
Object.defineProperty(Shape.prototype, "type", {
    get: function() {
        return wrapPointer(_two_Shape__get_type(this.__ptr), Type);
    }});
Shape.prototype["__destroy"] = Shape.prototype.__destroy = function() {
    _two_Shape__destroy(this.__ptr);
};
// ShapeVar
function ShapeVar(a0) {
    if (a0 === undefined) {  }
    else { if (!checkClass(a0, Shape)) throw Error('ShapeVar(0:shape): expected Shape'); }
    if (a0 === undefined) { this.__ptr = _two_ShapeVar__construct_0(); getCache(ShapeVar)[this.__ptr] = this; }
    else { this.__ptr = _two_ShapeVar__construct_1(/*shape*/a0.__ptr); getCache(ShapeVar)[this.__ptr] = this; }
};
...
Object.defineProperty(ShapeVar.prototype, "shape", {
    get: function() {
        return wrapPointer(_two_ShapeVar__get_shape(this.__ptr), Shape);
    }});
ShapeVar.prototype["__destroy"] = ShapeVar.prototype.__destroy = function() {
    _two_ShapeVar__destroy(this.__ptr);
};
// Geometry
function Geometry() {
...
Geometry.prototype["__destroy"] = Geometry.prototype.__destroy = function() {
    _two_Geometry__destroy(this.__ptr);
};
// MeshPacker
function MeshPacker() {
...
MeshPacker.prototype["bones"] = MeshPacker.prototype.bones = function(a0) {
    ...
    _two_MeshPacker_bones_1(this.__ptr, /*j*/a0.__ptr);
};
MeshPacker.prototype["weights"] = MeshPacker.prototype.weights = function(a0) {
    if (!checkClass(a0, v4_float)) throw Error('weights(0:w): expected v4<float>');
    _two_MeshPacker_weights_1(this.__ptr, /*w*/a0.__ptr);
};
MeshPacker.prototype["index"] = MeshPacker.prototype.index = function(a0) {
    ...
    _two_MeshPacker_index_1(this.__ptr, /*i*/a0);
};
...
MeshPacker.prototype["pack"] = MeshPacker.prototype.pack = function(a0) {
    ...
    _two_MeshPacker_pack_1(this.__ptr, /*writer*/a0.__ptr);
};
MeshPacker.prototype["xpack"] = MeshPacker.prototype.xpack = function(a0, a1) {
    ...
    _two_MeshPacker_xpack_2(this.__ptr, /*writer*/a0.__ptr, /*transform*/a1.__ptr);
};
MeshPacker.prototype["unpack"] = MeshPacker.prototype.unpack = function(a0, a1) {
    ...
    _two_MeshPacker_unpack_2(this.__ptr, /*reader*/a0.__ptr, /*transform*/a1.__ptr);
};
MeshPacker.prototype["gen_normals"] = MeshPacker.prototype.gen_normals = function(a0) {
    ...
    if (a0 === undefined) { _two_MeshPacker_gen_normals_0(this.__ptr); }
...
function Line(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Line__construct_0(); getCache(Line)[this.__ptr] = this; }
    else { this.__ptr = _two_Line__construct_2(/*start*/a0.__ptr, /*end*/a1.__ptr); getCache(Line)[this.__ptr] = this; }
};
...
function Rect(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Rect__construct_0(); getCache(Rect)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Rect__construct_2(/*position*/a0.__ptr, /*size*/a1.__ptr); getCache(Rect)[this.__ptr] = this; }
    else { this.__ptr = _two_Rect__construct_4(/*x*/a0, /*y*/a1, /*w*/a2, /*h*/a3); getCache(Rect)[this.__ptr] = this; }
};
...
Object.defineProperty(Rect.prototype, "position", {
    get: function() {
        return wrapPointer(_two_Rect__get_position(this.__ptr), v2_float);
    },
    set: function(value) {
        if (!checkClass(value, v2_float)) throw Error('Rect.position: expected v2<float>');
        _two_Rect__set_position(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(Rect.prototype, "size", {
    get: function() {
        return wrapPointer(_two_Rect__get_size(this.__ptr), v2_float);
    },
    set: function(value) {
        if (!checkClass(value, v2_float)) throw Error('Rect.size: expected v2<float>');
        _two_Rect__set_size(this.__ptr, value.__ptr);
    }
});
Rect.prototype["__destroy"] = Rect.prototype.__destroy = function() {
    _two_Rect__destroy(this.__ptr);
};
// Quad
function Quad(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Quad__construct_0(); getCache(Quad)[this.__ptr] = this; }
    else { this.__ptr = _two_Quad__construct_4(/*a*/a0.__ptr, /*b*/a1.__ptr, /*c*/a2.__ptr, /*d*/a3.__ptr); getCache(Quad)[this.__ptr] = this; }
};
...
function Grid2(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Grid2__construct_0(); getCache(Grid2)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Grid2__construct_1(/*size*/a0.__ptr); getCache(Grid2)[this.__ptr] = this; }
    else { this.__ptr = _two_Grid2__construct_2(/*size*/a0.__ptr, /*space*/a1.__ptr); getCache(Grid2)[this.__ptr] = this; }
};
...
Object.defineProperty(Grid2.prototype, "size", {
    get: function() {
        return wrapPointer(_two_Grid2__get_size(this.__ptr), v2_float);
    },
    set: function(value) {
        if (!checkClass(value, v2_float)) throw Error('Grid2.size: expected v2<float>');
        _two_Grid2__set_size(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(Grid2.prototype, "space", {
    get: function() {
        return wrapPointer(_two_Grid2__get_space(this.__ptr), v2_float);
    },
    set: function(value) {
        if (!checkClass(value, v2_float)) throw Error('Grid2.space: expected v2<float>');
        _two_Grid2__set_space(this.__ptr, value.__ptr);
    }
});
Grid2.prototype["__destroy"] = Grid2.prototype.__destroy = function() {
    _two_Grid2__destroy(this.__ptr);
};
// Triangle
function Triangle(a0) {
    if (a0 === undefined) {  }
    else { if (!checkClass(a0, v2_float)) throw Error('Triangle(0:size): expected v2<float>'); }
    if (a0 === undefined) { this.__ptr = _two_Triangle__construct_0(); getCache(Triangle)[this.__ptr] = this; }
    else { this.__ptr = _two_Triangle__construct_1(/*size*/a0.__ptr); getCache(Triangle)[this.__ptr] = this; }
};
...
Object.defineProperty(Triangle.prototype, "size", {
    get: function() {
        return wrapPointer(_two_Triangle__get_size(this.__ptr), v2_float);
    },
    set: function(value) {
        if (!checkClass(value, v2_float)) throw Error('Triangle.size: expected v2<float>');
        _two_Triangle__set_size(this.__ptr, value.__ptr);
    }
});
Triangle.prototype["__destroy"] = Triangle.prototype.__destroy = function() {
    _two_Triangle__destroy(this.__ptr);
};
// Circle
function Circle(a0, a1, a2) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Circle__construct_0(); getCache(Circle)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Circle__construct_1(/*radius*/a0); getCache(Circle)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Circle__construct_2(/*radius*/a0, /*axis*/a1); getCache(Circle)[this.__ptr] = this; }
    else { this.__ptr = _two_Circle__construct_3(/*center*/a0.__ptr, /*radius*/a1, /*axis*/a2); getCache(Circle)[this.__ptr] = this; }
};
...
function Torus(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Torus__construct_0(); getCache(Torus)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Torus__construct_2(/*radius*/a0, /*tube*/a1); getCache(Torus)[this.__ptr] = this; }
    else if (a3 === undefined) { this.__ptr = _two_Torus__construct_3(/*radius*/a0, /*tube*/a1, /*axis*/a2); getCache(Torus)[this.__ptr] = this; }
    else { this.__ptr = _two_Torus__construct_4(/*center*/a0.__ptr, /*radius*/a1, /*tube*/a2, /*axis*/a3); getCache(Torus)[this.__ptr] = this; }
};
...
function TorusKnot(a0, a1, a2, a3, a4) {
    ...
    if (a0 === undefined) { this.__ptr = _two_TorusKnot__construct_0(); getCache(TorusKnot)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_TorusKnot__construct_2(/*radius*/a0, /*tube*/a1); getCache(TorusKnot)[this.__ptr] = this; }
    else if (a3 === undefined) { this.__ptr = _two_TorusKnot__construct_3(/*radius*/a0, /*tube*/a1, /*p*/a2); getCache(TorusKnot)[this.__ptr] = this; }
    else if (a4 === undefined) { this.__ptr = _two_TorusKnot__construct_4(/*radius*/a0, /*tube*/a1, /*p*/a2, /*q*/a3); getCache(TorusKnot)[this.__ptr] = this; }
    else { this.__ptr = _two_TorusKnot__construct_5(/*center*/a0.__ptr, /*radius*/a1, /*tube*/a2, /*p*/a3, /*q*/a4); getCache(TorusKnot)[this.__ptr] = this; }
};
...
function Ring(a0, a1, a2) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Ring__construct_0(); getCache(Ring)[this.__ptr] = this; }
    else { this.__ptr = _two_Ring__construct_3(/*radius*/a0, /*min*/a1, /*max*/a2); getCache(Ring)[this.__ptr] = this; }
};
...
function Ellipsis(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Ellipsis__construct_0(); getCache(Ellipsis)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Ellipsis__construct_1(/*radius*/a0.__ptr); getCache(Ellipsis)[this.__ptr] = this; }
    else { this.__ptr = _two_Ellipsis__construct_2(/*radius*/a0.__ptr, /*axis*/a1); getCache(Ellipsis)[this.__ptr] = this; }
};
...
function Arc(a0, a1, a2) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Arc__construct_0(); getCache(Arc)[this.__ptr] = this; }
    else { this.__ptr = _two_Arc__construct_3(/*radius*/a0, /*start*/a1, /*end*/a2); getCache(Arc)[this.__ptr] = this; }
};
...
function ArcLine(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_ArcLine__construct_0(); getCache(ArcLine)[this.__ptr] = this; }
    else if (a3 === undefined) { this.__ptr = _two_ArcLine__construct_3(/*start*/a0.__ptr, /*middle*/a1.__ptr, /*end*/a2.__ptr); getCache(ArcLine)[this.__ptr] = this; }
    else { this.__ptr = _two_ArcLine__construct_4(/*center*/a0.__ptr, /*start*/a1.__ptr, /*middle*/a2.__ptr, /*end*/a3.__ptr); getCache(ArcLine)[this.__ptr] = this; }
};
...
function Cylinder(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Cylinder__construct_0(); getCache(Cylinder)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Cylinder__construct_2(/*radius*/a0, /*height*/a1); getCache(Cylinder)[this.__ptr] = this; }
    else if (a3 === undefined) { this.__ptr = _two_Cylinder__construct_3(/*radius*/a0, /*height*/a1, /*axis*/a2); getCache(Cylinder)[this.__ptr] = this; }
    else { this.__ptr = _two_Cylinder__construct_4(/*center*/a0.__ptr, /*radius*/a1, /*height*/a2, /*axis*/a3); getCache(Cylinder)[this.__ptr] = this; }
};
...
function Capsule(a0, a1, a2) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Capsule__construct_0(); getCache(Capsule)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Capsule__construct_2(/*radius*/a0, /*height*/a1); getCache(Capsule)[this.__ptr] = this; }
    else { this.__ptr = _two_Capsule__construct_3(/*radius*/a0, /*height*/a1, /*axis*/a2); getCache(Capsule)[this.__ptr] = this; }
};
...
function Cube(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Cube__construct_0(); getCache(Cube)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Cube__construct_1(/*extents*/a0.__ptr); getCache(Cube)[this.__ptr] = this; }
    else { this.__ptr = _two_Cube__construct_2(/*center*/a0.__ptr, /*extents*/a1.__ptr); getCache(Cube)[this.__ptr] = this; }
};
...
Object.defineProperty(Cube.prototype, "extents", {
    get: function() {
        return wrapPointer(_two_Cube__get_extents(this.__ptr), v3_float);
    },
    set: function(value) {
        if (!checkClass(value, v3_float)) throw Error('Cube.extents: expected v3<float>');
        _two_Cube__set_extents(this.__ptr, value.__ptr);
    }
});
Cube.prototype["__destroy"] = Cube.prototype.__destroy = function() {
    _two_Cube__destroy(this.__ptr);
};
// Tetraedr
function Tetraedr(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Tetraedr__construct_0(); getCache(Tetraedr)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Tetraedr__construct_1(/*radius*/a0); getCache(Tetraedr)[this.__ptr] = this; }
    else { this.__ptr = _two_Tetraedr__construct_2(/*center*/a0.__ptr, /*radius*/a1); getCache(Tetraedr)[this.__ptr] = this; }
};
...
function Sphere(a0, a1, a2, a3) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Sphere__construct_0(); getCache(Sphere)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Sphere__construct_1(/*radius*/a0); getCache(Sphere)[this.__ptr] = this; }
    else if (a2 === undefined) { this.__ptr = _two_Sphere__construct_2(/*radius*/a0, /*start*/a1); getCache(Sphere)[this.__ptr] = this; }
    else if (a3 === undefined) { this.__ptr = _two_Sphere__construct_3(/*radius*/a0, /*start*/a1, /*end*/a2); getCache(Sphere)[this.__ptr] = this; }
    else { this.__ptr = _two_Sphere__construct_4(/*center*/a0.__ptr, /*radius*/a1, /*start*/a2, /*end*/a3); getCache(Sphere)[this.__ptr] = this; }
};
...
function SphereRing(a0, a1, a2) {
    ...
    if (a0 === undefined) { this.__ptr = _two_SphereRing__construct_0(); getCache(SphereRing)[this.__ptr] = this; }
    else { this.__ptr = _two_SphereRing__construct_3(/*radius*/a0, /*min*/a1, /*max*/a2); getCache(SphereRing)[this.__ptr] = this; }
};
...
function Spheroid(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Spheroid__construct_0(); getCache(Spheroid)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Spheroid__construct_1(/*radius*/a0); getCache(Spheroid)[this.__ptr] = this; }
    else { this.__ptr = _two_Spheroid__construct_2(/*center*/a0.__ptr, /*radius*/a1); getCache(Spheroid)[this.__ptr] = this; }
};
...
function Icosaedr(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Icosaedr__construct_0(); getCache(Icosaedr)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Icosaedr__construct_1(/*radius*/a0); getCache(Icosaedr)[this.__ptr] = this; }
    else { this.__ptr = _two_Icosaedr__construct_2(/*center*/a0.__ptr, /*radius*/a1); getCache(Icosaedr)[this.__ptr] = this; }
};
...
Distribution.prototype["__destroy"] = Distribution.prototype.__destroy = function() {
    _two_Distribution__destroy(this.__ptr);
};
// Poisson
function Poisson(a0, a1) {
    ...
    this.__ptr = _two_Poisson__construct_2(/*size*/a0.__ptr, /*maxRadius*/a1); getCache(Poisson)[this.__ptr] = this;
};
...
Poisson.prototype["distribute"] = Poisson.prototype.distribute = function(a0) {
    ...
    return _two_Poisson_distribute_1(this.__ptr, /*radius*/a0);
};
Poisson.prototype["addPoint"] = Poisson.prototype.addPoint = function(a0, a1) {
    ...
    return !!(_two_Poisson_addPoint_2(this.__ptr, /*radius*/a0, /*point*/a1.__ptr));
};
Poisson.prototype["__destroy"] = Poisson.prototype.__destroy = function() {
    _two_Poisson__destroy(this.__ptr);
};
// Polygon
function Polygon(a0) {
    if (a0 === undefined) {  }
    else {  }
    if (a0 === undefined) { this.__ptr = _two_Polygon__construct_0(); getCache(Polygon)[this.__ptr] = this; }
    else { this.__ptr = _two_Polygon__construct_1(ensureFloat32(/*vertices*/a0), /*vertices*/a0.length); getCache(Polygon)[this.__ptr] = this; }
};
...
Polygon.prototype["__destroy"] = Polygon.prototype.__destroy = function() {
    _two_Polygon__destroy(this.__ptr);
};
// Box
function Box() {
...
Box.prototype["__destroy"] = Box.prototype.__destroy = function() {
    _two_Box__destroy(this.__ptr);
};
// Points
function Points(a0) {
    if (a0 === undefined) {  }
    else {  }
    if (a0 === undefined) { this.__ptr = _two_Points__construct_0(); getCache(Points)[this.__ptr] = this; }
    else { this.__ptr = _two_Points__construct_1(ensureFloat32(/*points*/a0), /*points*/a0.length); getCache(Points)[this.__ptr] = this; }
};
...
Object.defineProperty(Points.prototype, "points", {
    get: function() {
        return _two_Points__get_points(this.__ptr);
    }});
Points.prototype["__destroy"] = Points.prototype.__destroy = function() {
    _two_Points__destroy(this.__ptr);
};
// Grid3
function Grid3(a0, a1) {
    ...
    if (a0 === undefined) { this.__ptr = _two_Grid3__construct_0(); getCache(Grid3)[this.__ptr] = this; }
    else if (a1 === undefined) { this.__ptr = _two_Grid3__construct_1(/*size*/a0.__ptr); getCache(Grid3)[this.__ptr] = this; }
    else { this.__ptr = _two_Grid3__construct_2(/*size*/a0.__ptr, ensureFloat32(/*points*/a1), /*points*/a1.length); getCache(Grid3)[this.__ptr] = this; }
};
...
Object.defineProperty(Grid3.prototype, "size", {
    get: function() {
        return wrapPointer(_two_Grid3__get_size(this.__ptr), v2_uint);
    },
    set: function(value) {
        if (!checkClass(value, v2_uint)) throw Error('Grid3.size: expected v2<uint>');
        _two_Grid3__set_size(this.__ptr, value.__ptr);
    }
});
Object.defineProperty(Grid3.prototype, "points", {
    get: function() {
        return _two_Grid3__get_points(this.__ptr);
    }});
Grid3.prototype["__destroy"] = Grid3.prototype.__destroy = function() {
    _two_Grid3__destroy(this.__ptr);
};
// ConvexHull
function ConvexHull(a0) {
    if (a0 === undefined) {  }
    else {  }
    if (a0 === undefined) { this.__ptr = _two_ConvexHull__construct_0(); getCache(ConvexHull)[this.__ptr] = this; }
    else { this.__ptr = _two_ConvexHull__construct_1(ensureFloat32(/*vertices*/a0), /*vertices*/a0.length); getCache(ConvexHull)[this.__ptr] = this; }
};
...
Object.defineProperty(ConvexHull.prototype, "vertices", {
    get: function() {
        return _two_ConvexHull__get_vertices(this.__ptr);
    }});
ConvexHull.prototype["__destroy"] = ConvexHull.prototype.__destroy = function() {
    _two_ConvexHull__destroy(this.__ptr);
};
// Symbol
function Symbol(a0, a1, a2, a3, a4) {
    ...
    else { this.__ptr = _two_Symbol__construct_5(/*fill*/a0.__ptr, /*outline*/a1.__ptr, /*overlay*/a2, /*double_sided*/a3, /*detail*/a4); getCache(Symbol)[this.__ptr] = this; }
};
...
MarchingCubes.prototype["direct"] = MarchingCubes.prototype.direct = function(a0) {
    ...
    _two_MarchingCubes_direct_1(this.__ptr, /*output*/a0.__ptr);
};
...
Module['to_ray'] = function(a0, a1, a2) {
    ...
    if (a2 === undefined) { return wrapPointer(_two_to_ray_2(/*pos*/a0.__ptr, /*dir*/a1.__ptr), Ray); }
    else { return wrapPointer(_two_to_ray_3(/*pos*/a0.__ptr, /*dir*/a1.__ptr, /*distance*/a2), Ray); }
};
Module['to_segment'] = function(a0) {
    if (!checkClass(a0, Ray)) throw Error('to_segment(0:ray): expected Ray');
    return wrapPointer(_two_to_segment_1(/*ray*/a0.__ptr), Segment);
};
Module['distribute_poisson'] = function(a0, a1) {
    ...
    return _two_distribute_poisson_2(/*size*/a0.__ptr, /*radius*/a1);
};
Module['add_ball'] = function(a0, a1, a2, a3, a4) {
    ...
    if (a4 === undefined) { _two_add_ball_4(/*cubes*/a0.__ptr, /*ball*/a1.__ptr, /*strength*/a2, /*subtract*/a3); }
    else { _two_add_ball_5(/*cubes*/a0.__ptr, /*ball*/a1.__ptr, /*strength*/a2, /*subtract*/a3, /*colour*/a4.__ptr); }
};
Module['add_planeX'] = function(a0, a1, a2) {
    ...
    _two_add_planeX_3(/*cubes*/a0.__ptr, /*strength*/a1, /*subtract*/a2);
};
Module['add_planeY'] = function(a0, a1, a2) {
    ...
    _two_add_planeY_3(/*cubes*/a0.__ptr, /*strength*/a1, /*subtract*/a2);
};
Module['add_planeZ'] = function(a0, a1, a2) {
    ...
    _two_add_planeZ_3(/*cubes*/a0.__ptr, /*strength*/a1, /*subtract*/a2);
};

(function() {
    function setup() {
        Aabb.prototype.__type = _two_Aabb__type();
        Curve2.prototype.__type = _two_Curve2__type();
        Curve3.prototype.__type = _two_Curve3__type();
        CurveSpline.prototype.__type = _two_CurveSpline__type();
        CurveSpline3.prototype.__type = _two_CurveSpline3__type();
        CurveBezierCubic.prototype.__type = _two_CurveBezierCubic__type();
        CurveBezierCubic3.prototype.__type = _two_CurveBezierCubic3__type();
        CurveLine.prototype.__type = _two_CurveLine__type();
        CurveLine3.prototype.__type = _two_CurveLine3__type();
        CurveBezierQuadratic.prototype.__type = _two_CurveBezierQuadratic__type();
        CurveBezierQuadratic3.prototype.__type = _two_CurveBezierQuadratic3__type();
        CurveCatmullRom3.prototype.__type = _two_CurveCatmullRom3__type();
        Plane.prototype.__type = _two_Plane__type();
        Plane3.prototype.__type = _two_Plane3__type();
        Face3.prototype.__type = _two_Face3__type();
        Segment.prototype.__type = _two_Segment__type();
        Ray.prototype.__type = _two_Ray__type();
        MeshAdapter.prototype.__type = _two_MeshAdapter__type();
        Shape.prototype.__type = _two_Shape__type();
        ShapeVar.prototype.__type = _two_ShapeVar__type();
        Geometry.prototype.__type = _two_Geometry__type();
        MeshPacker.prototype.__type = _two_MeshPacker__type();
        Line.prototype.__type = _two_Line__type();
        Rect.prototype.__type = _two_Rect__type();
        Quad.prototype.__type = _two_Quad__type();
        Grid2.prototype.__type = _two_Grid2__type();
        Triangle.prototype.__type = _two_Triangle__type();
        Circle.prototype.__type = _two_Circle__type();
        Torus.prototype.__type = _two_Torus__type();
        TorusKnot.prototype.__type = _two_TorusKnot__type();
        Ring.prototype.__type = _two_Ring__type();
        Ellipsis.prototype.__type = _two_Ellipsis__type();
        Arc.prototype.__type = _two_Arc__type();
        ArcLine.prototype.__type = _two_ArcLine__type();
        Cylinder.prototype.__type = _two_Cylinder__type();
        Capsule.prototype.__type = _two_Capsule__type();
        Cube.prototype.__type = _two_Cube__type();
        Tetraedr.prototype.__type = _two_Tetraedr__type();
        Sphere.prototype.__type = _two_Sphere__type();
        SphereRing.prototype.__type = _two_SphereRing__type();
        Spheroid.prototype.__type = _two_Spheroid__type();
        Icosaedr.prototype.__type = _two_Icosaedr__type();
        Distribution.prototype.__type = _two_Distribution__type();
        Poisson.prototype.__type = _two_Poisson__type();
        Polygon.prototype.__type = _two_Polygon__type();
        Box.prototype.__type = _two_Box__type();
        Points.prototype.__type = _two_Points__type();
        Grid3.prototype.__type = _two_Grid3__type();
        ConvexHull.prototype.__type = _two_ConvexHull__type();
        Symbol.prototype.__type = _two_Symbol__type();
        MarchingCubes.prototype.__type = _two_MarchingCubes__type();
        // CatmullType
        Module['CatmullType'] = Module['CatmullType'] || {};
        Module['CatmullType']['Centripetal'] = _two_CatmullType_Centripetal();
        Module['CatmullType']['Chordal'] = _two_CatmullType_Chordal();
        Module['CatmullType']['CatmullRom'] = _two_CatmullType_CatmullRom();
        // DrawMode
        Module['OUTLINE'] = _two_DrawMode_OUTLINE();
        Module['PLAIN'] = _two_DrawMode_PLAIN();
        // PrimitiveType
        Module['PrimitiveType'] = Module['PrimitiveType'] || {};
        Module['PrimitiveType']['Points'] = _two_PrimitiveType_Points();
        Module['PrimitiveType']['Lines'] = _two_PrimitiveType_Lines();
        Module['PrimitiveType']['LineStrip'] = _two_PrimitiveType_LineStrip();
        Module['PrimitiveType']['Triangles'] = _two_PrimitiveType_Triangles();
        Module['PrimitiveType']['TriangleStrip'] = _two_PrimitiveType_TriangleStrip();
        Module['PrimitiveType']['TriangleFan'] = _two_PrimitiveType_TriangleFan();
        Module['PrimitiveType']['Count'] = _two_PrimitiveType_Count();
        // SymbolDetail
        Module['SymbolDetail'] = Module['SymbolDetail'] || {};
        Module['SymbolDetail']['Lowest'] = _two_SymbolDetail_Lowest();
        Module['SymbolDetail']['Low'] = _two_SymbolDetail_Low();
        Module['SymbolDetail']['Medium'] = _two_SymbolDetail_Medium();
        Module['SymbolDetail']['High'] = _two_SymbolDetail_High();
        Module['SymbolDetail']['Highest'] = _two_SymbolDetail_Highest();
    }
