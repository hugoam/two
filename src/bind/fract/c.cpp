...
extern "C" {
	...
	mud::Pattern* DECL mud_Pattern_Pattern_3(mud::Palette* palette, mud::PatternSampling sampling, float precision) {
		return new mud::Pattern(*palette, sampling, precision);
	}
	mud::Pattern* DECL mud_Pattern_Pattern_4(mud::Palette* palette, mud::PatternSampling sampling, float precision, size_t step) {
