...
function ImporterGltf(a0) {
    ...
    this.__ptr = _two_ImporterGltf__construct_1(/*gfx*/a0.__ptr); getCache(ImporterGltf)[this.__ptr] = this;
};
...
ImporterGltf.prototype["import"] = ImporterGltf.prototype.import = function(a0, a1, a2) {
    ...
    _two_ImporterGltf_import_3(this.__ptr, /*import*/a0.__ptr, ensureString(/*filepath*/a1), /*config*/a2.__ptr);
};
ImporterGltf.prototype["import_model"] = ImporterGltf.prototype.import_model = function(a0, a1, a2) {
    ...
    _two_ImporterGltf_import_model_3(this.__ptr, /*model*/a0.__ptr, ensureString(/*filepath*/a1), /*config*/a2.__ptr);
};
ImporterGltf.prototype["import_prefab"] = ImporterGltf.prototype.import_prefab = function(a0, a1, a2) {
    ...
    _two_ImporterGltf_import_prefab_3(this.__ptr, /*prefab*/a0.__ptr, ensureString(/*filepath*/a1), /*config*/a2.__ptr);
};
ImporterGltf.prototype["repack"] = ImporterGltf.prototype.repack = function(a0, a1) {
    ...
    _two_ImporterGltf_repack_2(this.__ptr, ensureString(/*filepath*/a0), /*config*/a1.__ptr);
};
ImporterGltf.prototype["__destroy"] = ImporterGltf.prototype.__destroy = function() {
    _two_ImporterGltf__destroy(this.__ptr);
};

(function() {
    function setup() {
        ImporterGltf.prototype.__type = _two_ImporterGltf__type();
    }
