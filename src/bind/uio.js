...
ScriptEditor.prototype["__destroy"] = ScriptEditor.prototype.__destroy = function() {
    _two_ScriptEditor__destroy(this.__ptr);
};
Module['object_edit_inline'] = function(a0, a1) {
    ...
    return !!(_two_object_edit_inline_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1)));
};
Module['object_edit_rows'] = function(a0, a1) {
    ...
    return !!(_two_object_edit_rows_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1)));
};
Module['object_edit_columns'] = function(a0, a1) {
    ...
    return !!(_two_object_edit_columns_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1)));
};
Module['object_edit_table'] = function(a0, a1) {
    ...
    return !!(_two_object_edit_table_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1)));
};
Module['object_edit_expandbox'] = function(a0, a1) {
    ...
    return !!(_two_object_edit_expandbox_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1)));
};
Module['object_edit'] = function(a0, a1, a2) {
    ...
    if (a2 === undefined) { return !!(_two_object_edit_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1))); }
    else { return !!(_two_object_edit_3(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1), /*hint*/a2)); }
};
Module['entity_edit'] = function(a0, a1, a2) {
    ...
    if (a2 === undefined) { return !!(_two_entity_edit_2(/*parent*/a0.__ptr, /*entity*/a1.__ptr)); }
    else { return !!(_two_entity_edit_3(/*parent*/a0.__ptr, /*entity*/a1.__ptr, /*hint*/a2)); }
};
Module['inspector'] = function(a0, a1) {
    ...
    if (a1 === undefined) { return !!(_two_inspector_1(/*parent*/a0.__ptr)); }
    else { return !!(_two_inspector_2(/*parent*/a0.__ptr, ensureRef(/*object*/a1), ensureRefType(/*object*/a1))); }
};

(function() {
    function setup() {
        ScriptEditor.prototype.__type = _two_ScriptEditor__type();
        // EditNestMode
        Module['EditNestMode'] = Module['EditNestMode'] || {};
        Module['EditNestMode']['Inline'] = _two_EditNestMode_Inline();
        Module['EditNestMode']['Modal'] = _two_EditNestMode_Modal();
        Module['EditNestMode']['Embed'] = _two_EditNestMode_Embed();
        // EditorHint
        Module['EditorHint'] = Module['EditorHint'] || {};
        Module['EditorHint']['Table'] = _two_EditorHint_Table();
        Module['EditorHint']['Rows'] = _two_EditorHint_Rows();
        Module['EditorHint']['Inline'] = _two_EditorHint_Inline();
    }
