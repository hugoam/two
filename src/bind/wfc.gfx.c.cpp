...
extern "C" {
	...
	mud::TileModel* DECL mud_TileModel__construct_0() {
	...
	mud::WfcBlock* DECL mud_WfcBlock__construct_0() {
		return new mud::WfcBlock();
	}
	mud::WfcBlock* DECL mud_WfcBlock__construct_4(const mud::vec3* position, const mud::uvec3* size, const mud::vec3* scale, mud::WaveTileset* tileset) {
		return new mud::WfcBlock(*position, *size, *scale, *tileset);
	}
	mud::WfcBlock* DECL mud_WfcBlock__construct_5(const mud::vec3* position, const mud::uvec3* size, const mud::vec3* scale, mud::WaveTileset* tileset, bool auto_solve) {
