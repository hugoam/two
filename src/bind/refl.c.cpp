...
extern "C" {
	...
	mud::Call* DECL mud_Call__construct_2(const mud::Callable* callable, stl::vector<mud::Var>* args) {
		return new mud::Call(*callable, *args);
	}
	...
	mud::Operator* DECL mud_Operator__construct_0() {
