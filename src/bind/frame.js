...
Shell.prototype["add_file"] = Shell.prototype.add_file = function(a0, a1, a2) {
    ensureCache.prepare();
    if (a2 === undefined) { _mud_Shell_add_file_2(this.__ptr, ensureString(/*path*/a0), ensureInt8(/*data*/a1), /*data*/a1.length); return; }
    _mud_Shell_add_file_3(this.__ptr, ensureString(/*path*/a0), ensureInt8(/*data*/a1), /*data*/a1.length, /*binary*/a2);
};
