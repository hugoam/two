...
namespace mud
{
	...
	export_ template <class T>
	inline void remove(vector<T>& vec, T value)
	{
	...
	inline auto remove_if(vector<T>& vec, Pred predicate)
	{
	...
	export_ template <class T>
	inline bool has(const vector<T>& vec, T value)
	{
	...
	export_ template <class T>
	inline bool contains(const vector<T>& vec, const vector<T>& other)
	{
	...
	export_ template <class T>
	inline void select(vector<T>& vec, T value) { vec.clear(); vec.push_back(value); }

	export_ template <class T>
	inline bool select_swap(vector<T>& vec, T value) { if(has(vec, value)) { remove(vec, value); return false; } else { vector_add(vec, value); return true; } }
