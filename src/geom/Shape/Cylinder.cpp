...
namespace mud
{
	...
	void draw_shape_lines(const ProcShape& shape, const Cylinder& cylinder, MeshData& data)
	{
		...
		uint16_t subdiv = circle_vertices(shape, shape.m_position + offset, vec2{ circle.m_radius }, to_signed_axis(circle.m_axis, true), true, data);
						  circle_vertices(shape, shape.m_position - offset, vec2{ circle.m_radius }, to_signed_axis(circle.m_axis, false), true, data);
	...
	void draw_shape_triangles(const ProcShape& shape, const Cylinder& cylinder, MeshData& data)
	{
		...
		uint16_t subdiv = circle_vertices(shape, shape.m_position - offset, vec2{ circle.m_radius }, to_signed_axis(circle.m_axis, false), false, data);
		...
		circle_vertices(shape, shape.m_position + offset, vec2{ circle.m_radius }, to_signed_axis(circle.m_axis, true), false, data);
		...
		circle_vertices(shape, shape.m_position - offset, vec2{ circle.m_radius }, to_signed_axis(circle.m_axis, false), false, data, true);
		circle_vertices(shape, shape.m_position + offset, vec2{ circle.m_radius }, to_signed_axis(circle.m_axis, true), false, data, true);
