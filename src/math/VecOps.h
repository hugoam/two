...
namespace mud
{
	...
	export_ template MUD_MATH_EXPORT _func_ vec3 add<vec3>(vec3 a, vec3 b);
	export_ template MUD_MATH_EXPORT _func_ vec3 subtract<vec3>(vec3 a, vec3 b);
	export_ template MUD_MATH_EXPORT _func_ vec3 multiply<vec3>(vec3 a, vec3 b);
	export_ template MUD_MATH_EXPORT _func_ vec3 divide<vec3>(vec3 a, vec3 b);
#else
