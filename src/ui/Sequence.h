...
namespace ui
{
	...
	export_ MUD_UI_EXPORT func_ bool multiselect_logic(Widget& element, Ref object, std::vector<Ref>& selection);
	...
	export_ MUD_UI_EXPORT Widget& element(Widget& parent, Ref object, std::vector<Ref>& selection);
