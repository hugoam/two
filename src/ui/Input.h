...
namespace ui
{
	...
	export_ MUD_UI_EXPORT _func_ bool drag_float(Widget& parent, float& value, float step = 0.1f);
	...
	export_ MUD_UI_EXPORT _func_ bool vec2_edit(Widget& parent, vec2& vec);
	export_ MUD_UI_EXPORT _func_ bool vec3_edit(Widget& parent, vec3& vec);
	export_ MUD_UI_EXPORT _func_ bool quat_edit(Widget& parent, quat& quat);
	...
	export_ MUD_UI_EXPORT _func_ bool color_edit_hsl(Widget& parent, const Colour& colour, Colour& value);
	export_ MUD_UI_EXPORT _func_ Widget& color_display(Widget& parent, const Colour& value);
	export_ MUD_UI_EXPORT _func_ bool color_edit(Widget& parent, Colour& value);
	export_ MUD_UI_EXPORT _func_ bool color_edit_simple(Widget& parent, Colour& value);
	export_ MUD_UI_EXPORT _func_ bool color_toggle_edit(Widget& parent, Colour& value);
	...
	export_ _func_ inline bool flag_field(Widget& parent, cstring name, uint32_t& value, uint8_t shift, bool reverse = false) { return field([&](Widget& self) { return flag_input(self, value, shift); }, parent, name, reverse); }
	export_ _func_ inline bool radio_field(Widget& parent, cstring name, array<cstring> choices, size_t& value, bool reverse = false) { return field([&](Widget& self) { return radio_switch(self, choices, value); }, parent, name, reverse); }
	export_ _func_ inline bool dropdown_field(Widget& parent, cstring name, array<cstring> choices, size_t& value, bool reverse = false) { return field([&](Widget& self) { return dropdown_input(self, choices, value); }, parent, name, reverse); }
	export_ _func_ inline bool typedown_field(Widget& parent, cstring name, array<cstring> choices, size_t& value, bool reverse = false) { return field([&](Widget& self) { return typedown_input(self, choices, value); }, parent, name, reverse); }
	export_ _func_ inline bool color_field(Widget& parent, cstring name, Colour& value, bool reverse = false) { return field([&](Widget& self) { return color_toggle_edit(self, value); }, parent, name, reverse); }
	export_ _func_ inline void color_display_field(Widget& parent, cstring name, const Colour& value, bool reverse = false) { field([&](Widget& self) { color_display(self, value); return false; }, parent, name, reverse); }
}
}
