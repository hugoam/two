...
namespace mud
{
	...
	public:
		...
		attr_ mut_ bool m_empty = true;
		attr_ mut_ Colour m_background_colour = Colour::None;
		attr_ mut_ Colour m_border_colour = Colour::None;
		attr_ mut_ Colour m_image_colour = Colour::None;
		attr_ mut_ Colour m_text_colour = Colour::None;
		attr_ mut_ string m_text_font = "dejavu";
		attr_ mut_ float m_text_size = 14.f;
		attr_ mut_ bool m_text_break = false;
		attr_ mut_ bool m_text_wrap = false;
		attr_ mut_ vec4 m_border_width = vec4(0.f);
		attr_ mut_ vec4 m_corner_radius = vec4(0.f);
		attr_ mut_ bool m_weak_corners = false;
		attr_ mut_ vec4 m_padding = vec4(0.f);
		attr_ mut_ vec4 m_margin = vec4(0.f);
		...
		attr_ mut_ ImageSkin m_image_skin;
		attr_ mut_ Shadow m_shadow;
		attr_ mut_ Colour m_shadow_colour;
		attr_ mut_ Style* m_hover_cursor = nullptr;
