...
namespace mud
{
    ...
    template <> MUD_UI_EXPORT Type& type<std::vector<float>>() { static Type ty("std::vector<float>"); return ty; }
    ...
    template <> MUD_UI_EXPORT Type& type<mud::UiRenderTarget>() { static Type ty("UiRenderTarget"); return ty; }
