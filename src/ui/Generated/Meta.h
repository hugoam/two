...
namespace mud
{
    ...
    // mud::FrameSolver
    {
        ...
        module.m_types.push_back(&type<mud::AutoLayout>());
        module.m_types.push_back(&type<mud::CanvasConnect>());
        module.m_types.push_back(&type<mud::Clipping>());
        module.m_types.push_back(&type<mud::Dim>());
        module.m_types.push_back(&type<mud::Dim2<mud::Align>>());
        module.m_types.push_back(&type<mud::Dim2<mud::AutoLayout>>());
        module.m_types.push_back(&type<mud::Dim2<mud::Pivot>>());
        module.m_types.push_back(&type<mud::Dim2<mud::Sizing>>());
        module.m_types.push_back(&type<mud::Dim2<size_t>>());
        module.m_types.push_back(&type<mud::Dock>());
        module.m_types.push_back(&type<mud::Docksystem>());
        module.m_types.push_back(&type<mud::Flow>());
        module.m_types.push_back(&type<mud::FlowAxis>());
        module.m_types.push_back(&type<mud::Gradient>());
        module.m_types.push_back(&type<mud::GridSolver>());
        module.m_types.push_back(&type<mud::Image>());
        module.m_types.push_back(&type<mud::ImageAtlas>());
        module.m_types.push_back(&type<mud::ImageSkin>());
        module.m_types.push_back(&type<mud::InkStyle>());
        module.m_types.push_back(&type<mud::Layer>());
        module.m_types.push_back(&type<mud::Layout>());
        module.m_types.push_back(&type<mud::LayoutSolver>());
        module.m_types.push_back(&type<mud::NodeConnection>());
        module.m_types.push_back(&type<mud::Opacity>());
        module.m_types.push_back(&type<mud::Paint>());
        module.m_types.push_back(&type<mud::Pivot>());
        module.m_types.push_back(&type<mud::Shadow>());
        module.m_types.push_back(&type<mud::Sizing>());
        module.m_types.push_back(&type<mud::Space>());
        module.m_types.push_back(&type<mud::SpacePreset>());
        module.m_types.push_back(&type<mud::Style>());
        module.m_types.push_back(&type<mud::Styler>());
        module.m_types.push_back(&type<mud::TableSolver>());
        module.m_types.push_back(&type<mud::Text>());
        module.m_types.push_back(&type<mud::TextCursor>());
    ...
    
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "widget", function_id<mud::Widget&(*)(mud::Widget&, mud::Style&, bool, mud::Dim, mud::Dim2<size_t>)>(&mud::ui::widget), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "item", function_id<mud::Widget&(*)(mud::Widget&, mud::Style&, cstring)>(&mud::ui::item), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "multi_item", function_id<mud::Widget&(*)(mud::Widget&, mud::Style&, mud::array<mud::cstring>, mud::Style*)>(&mud::ui::multi_item), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "multi_item", function_id<mud::Widget&(*)(mud::Widget&, mud::array<mud::cstring>, mud::Style*)>(&mud::ui::multi_item), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "spanner", function_id<mud::Widget&(*)(mud::Widget&, mud::Style&, mud::Dim, float)>(&mud::ui::spanner), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "spacer", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::spacer), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "icon", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::icon), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "label", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::label), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::text(val<mud::Widget>(args[0]), val<cstring>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "label", var(cstring()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "text", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::text), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "button", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::button), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "elements", var(mud::array<mud::cstring>()) }, { "element_style", Ref(type<mud::Style>()), Param::Flags(Param::Nullable|Param::Default) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "multi_button", function_id<mud::Widget&(*)(mud::Widget&, mud::array<mud::cstring>, mud::Style*)>(&mud::ui::multi_button), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "toggle", function_id<mud::Widget&(*)(mud::Widget&, bool&, cstring)>(&mud::ui::toggle), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "multi_toggle", function_id<mud::Widget&(*)(mud::Widget&, bool&, mud::array<mud::cstring>, mud::Style*)>(&mud::ui::multi_toggle), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "modal_button", function_id<bool(*)(mud::Widget&, mud::Widget&, cstring, uint32_t)>(&mud::ui::modal_button), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "modal_multi_button", function_id<bool(*)(mud::Widget&, mud::Widget&, mud::array<mud::cstring>, uint32_t)>(&mud::ui::modal_multi_button), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "checkbox", function_id<mud::Widget&(*)(mud::Widget&, bool&)>(&mud::ui::checkbox), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "fill_bar", function_id<mud::Widget&(*)(mud::Widget&, float, mud::Dim)>(&mud::ui::fill_bar), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "figure", function_id<mud::Widget&(*)(mud::Widget&, const mud::Image256&)>(&mud::ui::figure), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "radio_choice", function_id<mud::Widget&(*)(mud::Widget&, cstring, bool)>(&mud::ui::radio_choice), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "radio_switch", function_id<bool(*)(mud::Widget&, mud::array<mud::cstring>, size_t&, mud::Dim)>(&mud::ui::radio_switch), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "popdown", function_id<bool(*)(mud::Widget&, mud::array<mud::cstring>, size_t&, mud::vec2, mud::ui::PopupFlags)>(&mud::ui::popdown), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dropdown", function_id<mud::Widget&(*)(mud::Widget&, mud::Style&, cstring, mud::ui::PopupFlags, mud::Style*)>(&mud::ui::dropdown), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dropdown_input", function_id<bool(*)(mud::Widget&, mud::array<mud::cstring>, size_t&, bool)>(&mud::ui::dropdown_input), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "typedown_input", function_id<bool(*)(mud::Widget&, mud::array<mud::cstring>, size_t&)>(&mud::ui::typedown_input), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "menu_choice", function_id<mud::Widget&(*)(mud::Widget&, mud::array<mud::cstring>)>(&mud::ui::menu_choice), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "menu_choice", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::menu_choice), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "menu", function_id<mud::Widget&(*)(mud::Widget&, cstring, bool)>(&mud::ui::menu), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::menubar(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "menubar", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::menubar), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::toolbutton(val<mud::Widget>(args[0]), val<cstring>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "icon", var(cstring()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "toolbutton", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::toolbutton), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::tooldock(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tooldock", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::tooldock), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "toolbar", function_id<mud::Widget&(*)(mud::Widget&, bool)>(&mud::ui::toolbar), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::select_list(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "select_list", function_id<mud::ScrollSheet&(*)(mud::Widget&)>(&mud::ui::select_list), func, params, Ref(type<mud::ScrollSheet>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "columns", function_id<mud::Table&(*)(mud::Widget&, mud::array<float>)>(&mud::ui::columns), func, params, Ref(type<mud::Table>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "table", function_id<mud::Table&(*)(mud::Widget&, mud::array<mud::cstring>, mud::array<float>)>(&mud::ui::table), func, params, Ref(type<mud::Table>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::table_row(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "table_row", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::table_row), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "expandbox", function_id<mud::Expandbox&(*)(mud::Widget&, mud::array<mud::cstring>, bool)>(&mud::ui::expandbox), func, params, Ref(type<mud::Expandbox>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "expandbox", function_id<mud::Expandbox&(*)(mud::Widget&, cstring, bool)>(&mud::ui::expandbox), func, params, Ref(type<mud::Expandbox>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tree_node", function_id<mud::TreeNode&(*)(mud::Widget&, mud::array<mud::cstring>, bool, bool)>(&mud::ui::tree_node), func, params, Ref(type<mud::TreeNode>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tree_node", function_id<mud::TreeNode&(*)(mud::Widget&, cstring, bool, bool)>(&mud::ui::tree_node), func, params, Ref(type<mud::TreeNode>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::tree(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tree", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::tree), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tab", function_id<mud::Widget*(*)(mud::Tabber&, cstring)>(&mud::ui::tab), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::tabber(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tabber", function_id<mud::Tabber&(*)(mud::Widget&)>(&mud::ui::tabber), func, params, Ref(type<mud::Tabber>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::row(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "row", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::row), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::header(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "header", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::header), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::div(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "div", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::div), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::stack(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "stack", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::stack), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::sheet(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "sheet", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::sheet), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::board(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "board", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::board), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::layout(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "layout", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::layout), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::screen(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "screen", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::screen), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::decal(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "decal", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::decal), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::overlay(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "overlay", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::overlay), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "title_header", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::title_header), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dummy", function_id<mud::Widget&(*)(mud::Widget&, const mud::vec2&)>(&mud::ui::dummy), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "popup", function_id<mud::Widget&(*)(mud::Widget&, mud::ui::PopupFlags)>(&mud::ui::popup), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "popup", function_id<mud::Widget&(*)(mud::Widget&, const mud::vec2&, mud::ui::PopupFlags)>(&mud::ui::popup), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "popup_at", function_id<mud::Widget&(*)(mud::Widget&, const mud::vec2&, mud::ui::PopupFlags)>(&mud::ui::popup_at), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::modal(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "modal", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::modal), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::modal(val<mud::Widget>(args[0]), val<mud::vec2>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "size", var(mud::vec2()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "modal", function_id<mud::Widget&(*)(mud::Widget&, const mud::vec2&)>(&mud::ui::modal), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "auto_modal", function_id<mud::Widget&(*)(mud::Widget&, uint32_t)>(&mud::ui::auto_modal), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "auto_modal", function_id<mud::Widget&(*)(mud::Widget&, uint32_t, const mud::vec2&)>(&mud::ui::auto_modal), func, params, Ref(type<mud::Widget>()) });
        }
        {
        ...
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tooltip", function_id<mud::Widget*(*)(mud::Widget&, const mud::vec2&, float)>(&mud::ui::tooltip), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tooltip", function_id<mud::Widget*(*)(mud::Widget&, float)>(&mud::ui::tooltip), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tooltip", function_id<mud::Widget*(*)(mud::Widget&, const mud::vec2&, cstring)>(&mud::ui::tooltip), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "tooltip", function_id<mud::Widget*(*)(mud::Widget&, const mud::vec2&, mud::array<mud::cstring>)>(&mud::ui::tooltip), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "cursor", function_id<mud::Widget&(*)(mud::Widget&, const mud::vec2&, mud::Widget&, bool)>(&mud::ui::cursor), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "rectangle", function_id<mud::Widget&(*)(mud::Widget&, const mud::vec4&)>(&mud::ui::rectangle), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dockspace", function_id<mud::Dockspace&(*)(mud::Widget&, mud::Docksystem&)>(&mud::ui::dockspace), func, params, Ref(type<mud::Dockspace>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::dockbar(val<mud::Widget>(args[0]), val<mud::Docksystem>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "docksystem", Ref(type<mud::Docksystem>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dockbar", function_id<mud::Dockbar&(*)(mud::Widget&, mud::Docksystem&)>(&mud::ui::dockbar), func, params, Ref(type<mud::Dockbar>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dockitem", function_id<mud::Widget*(*)(mud::Widget&, mud::Docksystem&, mud::Dock&)>(&mud::ui::dockitem), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "text_box", function_id<mud::TextEdit&(*)(mud::Widget&, mud::Style&, std::string&, bool, size_t, const std::string&)>(&mud::ui::text_box), func, params, Ref(type<mud::TextEdit>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "type_in", function_id<mud::TextEdit&(*)(mud::Widget&, std::string&, size_t, const std::string&)>(&mud::ui::type_in), func, params, Ref(type<mud::TextEdit>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "text_edit", function_id<mud::TextEdit&(*)(mud::Widget&, std::string&, size_t, std::vector<std::string>*)>(&mud::ui::text_edit), func, params, Ref(type<mud::TextEdit>()) });
        }
        {
            ...
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "text", var(std::string()) }, { "lines", var(size_t()), Param::Default }, { "vocabulary", Ref(type<std::vector<std::string>>()), Param::Flags(Param::Nullable|Param::Default) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "code_edit", function_id<mud::TextEdit&(*)(mud::Widget&, std::string&, size_t, std::vector<std::string>*)>(&mud::ui::code_edit), func, params, Ref(type<mud::TextEdit>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "drag_float", function_id<bool(*)(mud::Widget&, float&, float)>(&mud::ui::drag_float), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "vec2_edit", function_id<bool(*)(mud::Widget&, mud::vec2&)>(&mud::ui::vec2_edit), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "vec3_edit", function_id<bool(*)(mud::Widget&, mud::vec3&)>(&mud::ui::vec3_edit), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "quat_edit", function_id<bool(*)(mud::Widget&, mud::quat&)>(&mud::ui::quat_edit), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_edit_hsl", function_id<bool(*)(mud::Widget&, const mud::Colour&, mud::Colour&)>(&mud::ui::color_edit_hsl), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_display", function_id<mud::Widget&(*)(mud::Widget&, const mud::Colour&)>(&mud::ui::color_display), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  val<bool>(result) = mud::ui::color_edit(val<mud::Widget>(args[0]), val<mud::Colour>(args[1])); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "value", var(mud::Colour()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_edit", function_id<bool(*)(mud::Widget&, mud::Colour&)>(&mud::ui::color_edit), func, params, var(bool()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  val<bool>(result) = mud::ui::color_edit_simple(val<mud::Widget>(args[0]), val<mud::Colour>(args[1])); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "value", var(mud::Colour()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_edit_simple", function_id<bool(*)(mud::Widget&, mud::Colour&)>(&mud::ui::color_edit_simple), func, params, var(bool()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  val<bool>(result) = mud::ui::color_toggle_edit(val<mud::Widget>(args[0]), val<mud::Colour>(args[1])); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "value", var(mud::Colour()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_toggle_edit", function_id<bool(*)(mud::Widget&, mud::Colour&)>(&mud::ui::color_toggle_edit), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "flag_field", function_id<bool(*)(mud::Widget&, cstring, uint32_t&, uint8_t, bool)>(&mud::ui::flag_field), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "radio_field", function_id<bool(*)(mud::Widget&, cstring, mud::array<mud::cstring>, size_t&, bool)>(&mud::ui::radio_field), func, params, var(bool()) });
        }
        {
            ...
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "name", var(cstring()) }, { "choices", var(mud::array<mud::cstring>()) }, { "value", var(size_t()) }, { "reverse", var(bool(false)), Param::Default } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dropdown_field", function_id<bool(*)(mud::Widget&, cstring, mud::array<mud::cstring>, size_t&, bool)>(&mud::ui::dropdown_field), func, params, var(bool()) });
        }
        {
            ...
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "name", var(cstring()) }, { "choices", var(mud::array<mud::cstring>()) }, { "value", var(size_t()) }, { "reverse", var(bool(false)), Param::Default } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "typedown_field", function_id<bool(*)(mud::Widget&, cstring, mud::array<mud::cstring>, size_t&, bool)>(&mud::ui::typedown_field), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_field", function_id<bool(*)(mud::Widget&, cstring, mud::Colour&, bool)>(&mud::ui::color_field), func, params, var(bool()) });
        }
        {
            ...
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "name", var(cstring()) }, { "value", var(mud::Colour()) }, { "reverse", var(bool(false)), Param::Default } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "color_display_field", function_id<void(*)(mud::Widget&, cstring, const mud::Colour&, bool)>(&mud::ui::color_display_field), func, params, Var() });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "node_input", function_id<mud::NodePlug&(*)(mud::Node&, cstring, cstring, const mud::Colour&, bool, bool)>(&mud::ui::node_input), func, params, Ref(type<mud::NodePlug>()) });
        }
        {
            ...
            std::vector<Param> params = { { "node", Ref(type<mud::Node>()) }, { "name", var(cstring()) }, { "icon", var(cstring()), Param::Default }, { "colour", var(mud::Colour()), Param::Default }, { "active", var(bool(true)), Param::Default }, { "connected", var(bool(false)), Param::Default } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "node_output", function_id<mud::NodePlug&(*)(mud::Node&, cstring, cstring, const mud::Colour&, bool, bool)>(&mud::ui::node_output), func, params, Ref(type<mud::NodePlug>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "node", function_id<mud::Node&(*)(mud::Canvas&, cstring, mud::vec2&, int, mud::Ref)>(&mud::ui::node), func, params, Ref(type<mud::Node>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "node_cable", function_id<mud::Widget&(*)(mud::Canvas&, mud::NodePlug&, mud::NodePlug&)>(&mud::ui::node_cable), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "canvas", function_id<mud::Canvas&(*)(mud::Widget&, size_t)>(&mud::ui::canvas), func, params, Ref(type<mud::Canvas>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::scrollable(val<mud::Widget>(args[0]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "scrollable", function_id<mud::Widget&(*)(mud::Widget&)>(&mud::ui::scrollable), func, params, Ref(type<mud::Widget>()) });
        }
        {
        ...
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "select_logic", function_id<bool(*)(mud::Widget&, mud::Ref, std::vector<mud::Ref>&)>(&mud::ui::select_logic), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "select_logic", function_id<bool(*)(mud::Widget&, mud::Ref, mud::Ref&)>(&mud::ui::select_logic), func, params, var(bool()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "element", function_id<mud::Widget&(*)(mud::Widget&, mud::Ref)>(&mud::ui::element), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "element", function_id<mud::Widget&(*)(mud::Widget&, mud::Ref, std::vector<mud::Ref>&)>(&mud::ui::element), func, params, Ref(type<mud::Widget>()) });
        }
        {
        ...
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "window", function_id<mud::Window&(*)(mud::Widget&, cstring, mud::WindowState)>(&mud::ui::window), func, params, Ref(type<mud::Window>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dir_item", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::dir_item), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::file_item(val<mud::Widget>(args[0]), val<cstring>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "name", var(cstring()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "file_item", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::file_item), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "file_list", function_id<mud::Widget&(*)(mud::Widget&, std::string&)>(&mud::ui::file_list), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::file_browser(val<mud::Widget>(args[0]), val<std::string>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "path", var(std::string()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "file_browser", function_id<mud::Widget&(*)(mud::Widget&, std::string&)>(&mud::ui::file_browser), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "dir_node", function_id<mud::Widget&(*)(mud::Widget&, cstring, cstring, bool)>(&mud::ui::dir_node), func, params, Ref(type<mud::Widget>()) });
        }
        {
            auto func = [](array<Var> args, Var& result) {  result = Ref(&mud::ui::file_node(val<mud::Widget>(args[0]), val<cstring>(args[1]))); };
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "name", var(cstring()) } };
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "file_node", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::file_node), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "file_tree", function_id<mud::Widget&(*)(mud::Widget&, cstring)>(&mud::ui::file_tree), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "command_line", function_id<mud::Widget&(*)(mud::Widget&, std::string&, std::string&)>(&mud::ui::command_line), func, params, Ref(type<mud::Widget>()) });
        }
        {
            ...
            module.m_functions.push_back({ &namspc({ "mud", "ui" }), "console", function_id<mud::Widget&(*)(mud::Widget&, std::string&, std::string&, std::string&, size_t)>(&mud::ui::console), func, params, Ref(type<mud::Widget>()) });
        }
    }
#endif
