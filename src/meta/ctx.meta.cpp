...
void mud_InputEvent_consume(void* object, span<void*> args, void*& result) { (*static_cast<mud::InputEvent*>(result)) = (*static_cast<mud::InputEvent*>(object)).consume(*static_cast<mud::ControlNode*>(args[0])); }
