...
namespace mud
{
    ...
    // mud::ScriptEditor
    {
        ...
        }
        {
            ...
            static Function f = { &namspc({ "mud" }), "multi_inspector", function_id<void(*)(mud::Widget&, mud::Type&, vector<mud::Var>&, size_t&)>(&mud::multi_inspector), func, params, Var() };
            m.m_functions.push_back(&f);
        }
        {
            ...
            static Function f = { &namspc({ "mud" }), "multi_object_edit", function_id<void(*)(mud::Widget&, mud::Type&, vector<mud::Ref>)>(&mud::multi_object_edit), func, params, Var() };
            m.m_functions.push_back(&f);
        }
    }
}
