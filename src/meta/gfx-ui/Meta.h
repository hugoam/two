...
namespace mud
{
    ...
    // mud::SceneViewer
    {
        ...
        }
        {
            ...
            std::vector<Param> params = { { "parent", Ref(type<mud::Widget>()) }, { "size", var(mud::vec2(Zero2)), Param::Default } };
        ...
        }
        {
            ...
            std::vector<Param> params = { { "viewer", Ref(type<mud::Viewer>()) }, { "yaw", var(float()) }, { "pitch", var(float()) }, { "distance", var(float(10.f)), Param::Default } };
        ...
        }
        {
            ...
            std::vector<Param> params = { { "viewer", Ref(type<mud::Viewer>()) }, { "mode", var(mud::ui::OrbitMode()) }, { "entity", var(mud::Transform()) }, { "aiming", var(bool()) }, { "angles", var(mud::vec2()) }, { "modal", var(bool(false)), Param::Default } };
