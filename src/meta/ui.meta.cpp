...
namespace mud
{
	...
	
	{
		...
		{
			static Function f = { &namspc({ "mud", "ui" }), "spanner", nullptr, mud_ui_spanner_3, { { "parent", type<mud::Widget>(),  }, { "style", type<mud::Style>(),  }, { "dim", type<mud::Axis>(),  }, { "span", type<float>(),  } }, { &type<mud::Widget>(), QualType::None } };
			m.m_functions.push_back(&f);
		}
		{
