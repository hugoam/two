...
namespace mud
{
	...
	// Enums
	{
		...
		static Enum enu = { type<mud::DeviceType>(), true, ids, values, refs };
	...
	}
	{
		...
		static Enum enu = { type<mud::EventType>(), true, ids, values, refs };
	...
	}
	{
		...
		static Enum enu = { type<mud::InputMod>(), true, ids, values, refs };
	...
	}
	{
		...
		static Enum enu = { type<mud::Key>(), true, ids, values, refs };
		meta_enum<mud::Key>();
	}
	{
		...
		static Enum enu = { type<mud::MouseButtonCode>(), false, ids, values, refs };
