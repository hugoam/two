	...
	// mud::Context
	{
		...
		static Class cls = { t,
			...
			// members
			{
				...
				{ t, member_address(&mud::Context::m_width), type<unsigned int>(), "width", var(unsigned int()), Member::Value, nullptr },
				{ t, member_address(&mud::Context::m_height), type<unsigned int>(), "height", var(unsigned int()), Member::Value, nullptr },
