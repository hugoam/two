...
namespace mud
{
	export_ template <> inline void from_string(const string& str, mud::AnimationTarget& val) { val = static_cast<mud::AnimationTarget>(enu<mud::AnimationTarget>().value(str.c_str())); };
	export_ template <> inline void to_string(const mud::AnimationTarget& val, string& str) { str = enu<mud::AnimationTarget>().m_map[size_t(val)]; };
	...
	export_ template <> inline void from_string(const string& str, mud::Lighting& val) { val = static_cast<mud::Lighting>(enu<mud::Lighting>().value(str.c_str())); };
	export_ template <> inline void to_string(const mud::Lighting& val, string& str) { str = enu<mud::Lighting>().m_map[size_t(val)]; };
