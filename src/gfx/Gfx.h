...
namespace gfx
{
	...
	export_ MUD_GFX_EXPORT func_ Gnode& node(Gnode& parent, const vec3& position = vec3(0.f), const quat& rotation = ZeroQuat, const vec3& scale = vec3(1.f));
	export_ MUD_GFX_EXPORT Gnode& node(Gnode& parent, const mat4& transform);
	export_ MUD_GFX_EXPORT Gnode& node(Gnode& parent, const Transform& transform);
	export_ MUD_GFX_EXPORT Gnode& transform(Gnode& parent, const vec3& position, const quat& rotation, const vec3& scale);
	export_ MUD_GFX_EXPORT Gnode& transform(Gnode& parent, const vec3& position, const quat& rotation);
